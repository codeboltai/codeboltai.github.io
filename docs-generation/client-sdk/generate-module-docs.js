#!/usr/bin/env node
/**
 * Client SDK — Module Docs Generator
 *
 * Reads data/typedoc-data.json and generates Docusaurus-ready markdown:
 *   docs/05_reference/04_client-sdk/02_api-reference/{module}/index.md
 *   docs/05_reference/04_client-sdk/02_api-reference/{module}/{method}.md
 *
 * Usage:
