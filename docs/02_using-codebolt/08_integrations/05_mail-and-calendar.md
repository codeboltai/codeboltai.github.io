...
- [Communication (internals)](../../04_build-on-codebolt/08_internals/03_subsystems/11_communication.md)
- [Hooks](../../04_build-on-codebolt/06_hooks-and-capabilities/01_hooks-overview.md)
