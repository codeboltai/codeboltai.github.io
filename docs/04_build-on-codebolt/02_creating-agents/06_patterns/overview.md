...
All four patterns eventually produce the same thing — an agent that runs through the standard [lifecycle](../05_agent-anatomy/lifecycle.md). They differ in how much structure they impose on *your* code.
