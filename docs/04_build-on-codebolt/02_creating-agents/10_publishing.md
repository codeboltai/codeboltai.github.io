...
- [ ] You have replay tests committed (see [Testing](./09_testing-and-debugging.md)).
...
Private registries support access control, version pinning, and internal review workflows. See [Self-hosting → Registries](../10_self-hosting/01_overview.md) for running one.
