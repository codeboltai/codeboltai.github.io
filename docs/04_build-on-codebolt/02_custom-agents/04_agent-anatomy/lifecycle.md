...
This page is the *author's* view. For the server-side trace of the same lifecycle, see [Agent run end-to-end](../../08_internals/04_data-flow-walkthroughs/agent-run-end-to-end.md).
...
- For each tool call: validate args, run through [guardrails](../../08_internals/03_subsystems/09_guardrails-and-eval.md) (server-side, you don't do anything), call via `ctx.tools.call`, collect the result.
...
- [Agent run end-to-end](../../08_internals/04_data-flow-walkthroughs/agent-run-end-to-end.md) — the server-side view of the same stages
- [Testing and debugging](../06_testing-and-debugging.md)
