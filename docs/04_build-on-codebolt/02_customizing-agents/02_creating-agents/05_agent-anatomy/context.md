...
- **No raw database access.** You go through the services, always. If you think you need raw DB, you're writing the wrong thing — probably a [hook](../../06_hooks-and-capabilities/01_hooks-overview.md) or a [custom processor](../../03_processors/04_writing-a-custom-processor.md).
...
Lets the [context assembler](../../08_internals/03_subsystems/07_context-assembly.md) pull in rules, memory, codemap, vector hits, etc. Use this for "real" agent work.
