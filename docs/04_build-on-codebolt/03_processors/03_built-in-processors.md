...
The processors that ship with Codebolt. Most agents use a standard set of these automatically via [Unified Agent](../02_custom-agents/05_patterns/unified-agent.md). This page explains what each does so you know what to keep and what to drop when customising.
