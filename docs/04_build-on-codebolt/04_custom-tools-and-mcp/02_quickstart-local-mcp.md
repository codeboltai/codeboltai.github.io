...
6. **[Publish it](../02_custom-agents/07_publishing.md)** to a registry.
...
- [Publishing](../02_custom-agents/07_publishing.md)
- [Tool call end-to-end (internals)](../08_internals/04_data-flow-walkthroughs/tool-call-end-to-end.md)
