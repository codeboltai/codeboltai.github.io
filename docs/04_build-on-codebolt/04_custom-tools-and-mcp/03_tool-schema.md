...
For automated testing, record traces where the tool is used correctly and replay them. See [Testing and debugging](../02_custom-agents/06_testing-and-debugging.md).
