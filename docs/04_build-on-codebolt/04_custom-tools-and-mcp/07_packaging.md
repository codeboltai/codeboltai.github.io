...
Plain MCP servers are standalone executables. [Capability bundles](../06_hooks-and-capabilities/04_capabilities-overview.md) are Codebolt-specific packages that can include MCP servers alongside prompts, hooks, and UI panels.
...
- [Custom Tools & MCP Overview](./01_overview.md)
- [Publishing](../02_custom-agents/07_publishing.md) — after packaging comes publishing
