...
Bundle the provider alongside prompts, agents, or panels in a [capability](../03_agent-extensions/02_capabilities/01_overview.md).
...
- [LLM & Inference (internals)](../09_internals/03_subsystems/03_llm-and-inference.md) — the server side
