...
Running agents somewhere other than the local machine. Covers the user-facing side — when to enable it, how to configure, how to monitor. For building a custom remote execution backend, see [Custom Remote Execution Provider](./05_custom-providers/03_remote-execution-provider.md).
...
- **Custom** — write your own via [Custom Remote Execution Provider](./05_custom-providers/03_remote-execution-provider.md).
...
- [Custom Remote Execution Provider](./05_custom-providers/03_remote-execution-provider.md) — building one
- [Process Model (internals)](./08_internals/02_process-model.md)
- [Self-hosting](./09_self-hosting/01_overview.md) — often combined with remote execution
