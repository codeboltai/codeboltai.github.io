...
| <a id="enablelogging"></a> `enableLogging?` | `boolean` | Enable logging for debugging purposes. Defaults to true. | `AgentConfig.enableLogging` | - | packages/agent/src/unified/agent/codeboltAgent.ts:33 |
