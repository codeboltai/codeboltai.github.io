...
Defined in: packages/codeboltjs/src/tools/search/glob.ts:111

Implementation of the Glob tool logic

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`GlobToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
Defined in: packages/codeboltjs/src/tools/search/glob.ts:117
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'glob'` | - | - | packages/codeboltjs/src/tools/search/glob.ts:115 |
...
```ts
build(params: GlobToolParams): ToolInvocation<GlobToolParams, ToolFrameworkResult>;
```
...
[`ToolInvocation`](../interfaces/ToolInvocation)\<`GlobToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: GlobToolParams): ToolInvocation<GlobToolParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/search/glob.ts:161
...
```ts
validateBuildAndExecute(params: GlobToolParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
Defined in: packages/codeboltjs/src/tools/search/glob.ts:147
