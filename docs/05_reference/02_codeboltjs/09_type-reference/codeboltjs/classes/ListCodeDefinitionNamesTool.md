---
title: ListCodeDefinitionNamesTool
---
...
Defined in: packages/codeboltjs/src/tools/search/list-code-definition-names.ts:112

Implementation of the ListCodeDefinitionNames tool logic

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`ListCodeDefinitionNamesToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
new ListCodeDefinitionNamesTool(): ListCodeDefinitionNamesTool;
```

Defined in: packages/codeboltjs/src/tools/search/list-code-definition-names.ts:118
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'list_code_definition_names'` | - | - | packages/codeboltjs/src/tools/search/list-code-definition-names.ts:116 |
...
```ts
build(params: ListCodeDefinitionNamesToolParams): ToolInvocation<ListCodeDefinitionNamesToolParams, ToolFrameworkResult>;
```
...
[`ToolInvocation`](../interfaces/ToolInvocation)\<`ListCodeDefinitionNamesToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: ListCodeDefinitionNamesToolParams): ToolInvocation<ListCodeDefinitionNamesToolParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/search/list-code-definition-names.ts:157
...
```ts
validateBuildAndExecute(params: ListCodeDefinitionNamesToolParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
```ts
validateToolParams(params: ListCodeDefinitionNamesToolParams): string | null;
```
...
```ts
protected validateToolParamValues(params: ListCodeDefinitionNamesToolParams): string | null;
```

Defined in: packages/codeboltjs/src/tools/search/list-code-definition-names.ts:143
