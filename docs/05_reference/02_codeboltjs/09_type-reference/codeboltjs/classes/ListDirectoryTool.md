...
Defined in: packages/codeboltjs/src/tools/file/list-directory.ts:160

Implementation of the ListDirectory tool logic

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`ListDirectoryToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
new ListDirectoryTool(): ListDirectoryTool;
```

Defined in: packages/codeboltjs/src/tools/file/list-directory.ts:166
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'ls'` | - | - | packages/codeboltjs/src/tools/file/list-directory.ts:164 |
...
```ts
build(params: ListDirectoryToolParams): ToolInvocation<ListDirectoryToolParams, ToolFrameworkResult>;
```
...
[`ToolInvocation`](../interfaces/ToolInvocation)\<`ListDirectoryToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: ListDirectoryToolParams): ToolInvocation<ListDirectoryToolParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/file/list-directory.ts:231
...
```ts
validateBuildAndExecute(params: ListDirectoryToolParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
```ts
validateToolParams(params: ListDirectoryToolParams): string | null;
```
...
```ts
protected validateToolParamValues(params: ListDirectoryToolParams): string | null;
```

Defined in: packages/codeboltjs/src/tools/file/list-directory.ts:212
