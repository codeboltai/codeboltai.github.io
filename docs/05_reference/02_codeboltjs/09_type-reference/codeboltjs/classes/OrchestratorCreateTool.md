...
# Class: OrchestratorCreateTool

Defined in: packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts:79

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`OrchestratorCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
new OrchestratorCreateTool(): OrchestratorCreateTool;
```

Defined in: packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts:82
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'orchestrator_create'` | - | - | packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts:80 |
...
```ts
build(params: OrchestratorCreateParams): ToolInvocation<OrchestratorCreateParams, ToolFrameworkResult>;
```
...
| Parameter | Type |
| ------ | ------ |
| `params` | `OrchestratorCreateParams` |

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation)\<`OrchestratorCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: OrchestratorCreateParams): ToolInvocation<OrchestratorCreateParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts:130
...
```ts
validateBuildAndExecute(params: OrchestratorCreateParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
```ts
validateToolParams(params: OrchestratorCreateParams): string | null;
```
...
```ts
protected validateToolParamValues(params: OrchestratorCreateParams): string | null;
```

Defined in: packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts:117
