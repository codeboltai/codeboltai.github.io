...
Defined in: packages/codeboltjs/src/tools/search/search-files.ts:128

Implementation of the SearchFiles tool logic

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`SearchFilesToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
Defined in: packages/codeboltjs/src/tools/search/search-files.ts:134
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'search_files'` | - | - | packages/codeboltjs/src/tools/search/search-files.ts:132 |
...
```ts
build(params: SearchFilesToolParams): ToolInvocation<SearchFilesToolParams, ToolFrameworkResult>;
```
...
[`ToolInvocation`](../interfaces/ToolInvocation)\<`SearchFilesToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: SearchFilesToolParams): ToolInvocation<SearchFilesToolParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/search/search-files.ts:194
...
```ts
validateBuildAndExecute(params: SearchFilesToolParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
```ts
validateToolParams(params: SearchFilesToolParams): string | null;
```
...
```ts
protected validateToolParamValues(params: SearchFilesToolParams): string | null;
```

Defined in: packages/codeboltjs/src/tools/search/search-files.ts:169
