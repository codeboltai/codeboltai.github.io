...
Defined in: packages/codeboltjs/src/tools/file/write-file.ts:100

Implementation of the WriteFile tool logic

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`WriteFileToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
Defined in: packages/codeboltjs/src/tools/file/write-file.ts:106
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'write_file'` | - | - | packages/codeboltjs/src/tools/file/write-file.ts:104 |
...
```ts
build(params: WriteFileToolParams): ToolInvocation<WriteFileToolParams, ToolFrameworkResult>;
```
...
[`ToolInvocation`](../interfaces/ToolInvocation)\<`WriteFileToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: WriteFileToolParams): ToolInvocation<WriteFileToolParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/file/write-file.ts:154
...
```ts
validateBuildAndExecute(params: WriteFileToolParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
Defined in: packages/codeboltjs/src/tools/file/write-file.ts:135
