...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:158
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`Appreciation`](Appreciation) | Appreciation data - returned in 'data' property from cliLib | - | common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:160 |
