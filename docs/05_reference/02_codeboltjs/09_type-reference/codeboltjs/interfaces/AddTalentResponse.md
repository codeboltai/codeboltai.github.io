...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:162
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`Talent`](Talent) | Talent data - returned in 'data' property from cliLib | - | common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:164 |
