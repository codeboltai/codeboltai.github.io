...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:132
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`Testimonial`](Testimonial) | Created testimonial data - returned in 'data' property from cliLib | - | common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:134 |
