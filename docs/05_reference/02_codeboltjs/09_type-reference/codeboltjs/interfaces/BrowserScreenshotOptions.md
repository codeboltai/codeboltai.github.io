...
| ------ | ------ | ------ | ------ | ------ |
| <a id="format"></a> `format?` | `"png"` \| `"jpeg"` | Image format | - | packages/codeboltjs/src/types/libFunctionTypes.ts:861 |
| <a id="fullpage"></a> `fullPage?` | `boolean` | Take full page screenshot | - | packages/codeboltjs/src/types/libFunctionTypes.ts:857 |
...
| <a id="quality"></a> `quality?` | `number` | Image quality (0-100) | - | packages/codeboltjs/src/types/libFunctionTypes.ts:859 |
