...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/codemap.d.ts:77
...
| <a id="data"></a> `data?` | \{ `codemap`: [`CodemapInfo`](CodemapInfo); \} | - | common/types/dist/codeboltjstypes/libFunctionTypes/codemap.d.ts:78 |
| `data.codemap` | [`CodemapInfo`](CodemapInfo) | - | common/types/dist/codeboltjstypes/libFunctionTypes/codemap.d.ts:79 |
