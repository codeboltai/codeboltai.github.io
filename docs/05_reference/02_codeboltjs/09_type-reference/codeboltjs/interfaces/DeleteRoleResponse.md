...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:307
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:308 |
| `data.message` | `string` | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:309 |
