...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:166
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`Talent`](Talent) | Endorsement result - returned in 'data' property from cliLib | - | common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:168 |
