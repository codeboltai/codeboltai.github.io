...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:299
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `agents`: [`SwarmAgent`](SwarmAgent)[]; \} | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:300 |
| `data.agents` | [`SwarmAgent`](SwarmAgent)[] | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:301 |
