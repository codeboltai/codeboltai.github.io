...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:154
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KarmaEntry`](KarmaEntry)[] | Karma history - returned in 'data' property from cliLib | - | common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:156 |
