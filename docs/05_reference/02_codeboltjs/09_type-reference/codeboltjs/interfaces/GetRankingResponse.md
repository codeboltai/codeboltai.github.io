...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:174
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`RankingEntry`](RankingEntry)[] | Ranking entries - returned in 'data' property from cliLib | - | common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:176 |
