...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:184
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `agents`: [`SwarmAgent`](SwarmAgent)[]; \} | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:185 |
| `data.agents` | [`SwarmAgent`](SwarmAgent)[] | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:186 |
