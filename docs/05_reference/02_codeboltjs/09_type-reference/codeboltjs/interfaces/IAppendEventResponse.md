...
Defined in: packages/codeboltjs/src/modules/episodicMemory.ts:138
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`EpisodicEvent`](EpisodicEvent) | [`EpisodicMemoryResponse`](EpisodicMemoryResponse).[`data`](EpisodicMemoryResponse.md#data) | - | packages/codeboltjs/src/modules/episodicMemory.ts:139 |
