...
# Interface: IArchiveMemoryResponse

Defined in: packages/codeboltjs/src/modules/episodicMemory.ts:162
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | [`EpisodicMemoryResponse`](EpisodicMemoryResponse).[`data`](EpisodicMemoryResponse.md#data) | - | packages/codeboltjs/src/modules/episodicMemory.ts:163 |
| `data.message` | `string` | - | - | packages/codeboltjs/src/modules/episodicMemory.ts:164 |
