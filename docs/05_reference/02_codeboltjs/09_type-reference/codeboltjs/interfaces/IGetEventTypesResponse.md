...
# Interface: IGetEventTypesResponse

Defined in: packages/codeboltjs/src/modules/episodicMemory.ts:150
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | `string`[] | [`EpisodicMemoryResponse`](EpisodicMemoryResponse).[`data`](EpisodicMemoryResponse.md#data) | - | packages/codeboltjs/src/modules/episodicMemory.ts:151 |
