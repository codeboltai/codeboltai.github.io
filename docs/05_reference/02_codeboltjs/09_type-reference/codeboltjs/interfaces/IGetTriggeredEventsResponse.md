...
Defined in: packages/codeboltjs/src/modules/calendar.ts:221
...
| <a id="data"></a> `data?` | \{ `count`: `number`; `events`: [`CalendarEvent`](CalendarEvent)[]; \} | [`CalendarResponse`](CalendarResponse).[`data`](CalendarResponse.md#data) | - | packages/codeboltjs/src/modules/calendar.ts:222 |
| `data.count` | `number` | - | - | packages/codeboltjs/src/modules/calendar.ts:224 |
| `data.events` | [`CalendarEvent`](CalendarEvent)[] | - | - | packages/codeboltjs/src/modules/calendar.ts:223 |
