...
Defined in: packages/codeboltjs/src/modules/episodicMemory.ts:142
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `events`: [`EpisodicEvent`](EpisodicEvent)[]; `filtered`: `boolean`; `total`: `number`; \} | [`EpisodicMemoryResponse`](EpisodicMemoryResponse).[`data`](EpisodicMemoryResponse.md#data) | - | packages/codeboltjs/src/modules/episodicMemory.ts:143 |
| `data.events` | [`EpisodicEvent`](EpisodicEvent)[] | - | - | packages/codeboltjs/src/modules/episodicMemory.ts:144 |
| `data.filtered` | `boolean` | - | - | packages/codeboltjs/src/modules/episodicMemory.ts:146 |
| `data.total` | `number` | - | - | packages/codeboltjs/src/modules/episodicMemory.ts:145 |
