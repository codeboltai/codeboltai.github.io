...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/memoryIngestion.d.ts:113
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `specs`: `any`[]; \} | [`MemoryIngestionBaseResponse`](MemoryIngestionBaseResponse).[`data`](MemoryIngestionBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/memoryIngestion.d.ts:114 |
| `data.specs` | `any`[] | - | - | common/types/dist/codeboltjstypes/libFunctionTypes/memoryIngestion.d.ts:115 |
