...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:234
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:235 |
| `data.message` | `string` | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:236 |
