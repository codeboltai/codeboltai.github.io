...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:182
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `deleted`: `boolean`; \} | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:183 |
| `data.deleted` | `boolean` | - | - | common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:184 |
