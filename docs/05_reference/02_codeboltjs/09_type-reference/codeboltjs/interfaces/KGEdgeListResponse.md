...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:164
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGEdge`](KGEdge)[] | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:165 |
