...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:143
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGInstanceTemplate`](KGInstanceTemplate) | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:144 |
