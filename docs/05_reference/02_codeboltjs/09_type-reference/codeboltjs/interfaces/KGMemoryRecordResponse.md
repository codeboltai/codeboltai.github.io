...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:155
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGMemoryRecord`](KGMemoryRecord) | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:156 |
