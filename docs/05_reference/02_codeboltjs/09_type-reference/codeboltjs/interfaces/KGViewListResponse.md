...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:176
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGView`](KGView)[] | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:177 |
