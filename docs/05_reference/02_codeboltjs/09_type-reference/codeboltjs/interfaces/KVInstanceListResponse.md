...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:89
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `instances`: [`KVStoreInstance`](KVStoreInstance)[]; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:90 |
| `data.instances` | [`KVStoreInstance`](KVStoreInstance)[] | - | - | common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:91 |
