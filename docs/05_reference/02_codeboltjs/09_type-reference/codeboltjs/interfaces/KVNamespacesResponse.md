...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:120
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `namespaces`: `string`[]; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:121 |
| `data.namespaces` | `string`[] | - | - | common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:122 |
