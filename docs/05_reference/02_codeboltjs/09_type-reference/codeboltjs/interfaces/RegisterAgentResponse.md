...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:192
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `agentId`: `string`; `swarmId`: `string`; \} | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:193 |
| `data.agentId` | `string` | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:194 |
| `data.swarmId` | `string` | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:195 |
