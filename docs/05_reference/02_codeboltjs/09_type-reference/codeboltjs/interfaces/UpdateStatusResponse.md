...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:347
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:348 |
| `data.message` | `string` | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:349 |
