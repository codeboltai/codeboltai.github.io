...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:136
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`Testimonial`](Testimonial) | Updated testimonial data - returned in 'data' property from cliLib | - | common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:138 |
