...
# Interface: ArchiveTodoListResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:113
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="archived"></a> `archived?` | `boolean` | Archived status | - | common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:117 |
...
| <a id="id"></a> `id?` | `string` | Archived list ID | - | common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:115 |
