---
title: ChangeTodoItemStatusResponse
---
...
# Interface: ChangeTodoItemStatusResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:80
...
| <a id="status"></a> `status?` | `string` | New status | - | common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:84 |
...
| <a id="todo"></a> `todo?` | [`TodoItem`](TodoItem) | Updated todo item | - | common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:82 |
