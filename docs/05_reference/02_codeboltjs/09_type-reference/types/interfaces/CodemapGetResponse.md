...
| <a id="data"></a> `data?` | \{ `codemap`: [`Codemap`](Codemap) \| [`CodemapInfo`](CodemapInfo); \} | - | common/types/src/codeboltjstypes/libFunctionTypes/codemap.ts:83 |
| `data.codemap` | [`Codemap`](Codemap) \| [`CodemapInfo`](CodemapInfo) | - | common/types/src/codeboltjstypes/libFunctionTypes/codemap.ts:84 |
