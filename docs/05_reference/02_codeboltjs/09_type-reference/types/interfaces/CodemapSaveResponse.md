...
| <a id="data"></a> `data?` | \{ `codemap`: [`CodemapInfo`](CodemapInfo); \} | - | common/types/src/codeboltjstypes/libFunctionTypes/codemap.ts:95 |
| `data.codemap` | [`CodemapInfo`](CodemapInfo) | - | common/types/src/codeboltjstypes/libFunctionTypes/codemap.ts:96 |
