---
title: CreateOrchestratorResponse
---
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`OrchestratorInstance`](OrchestratorInstance) | - | common/types/src/codeboltjstypes/libFunctionTypes/orchestrator.ts:108 |
...
| <a id="requestid"></a> `requestId?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/orchestrator.ts:107 |
