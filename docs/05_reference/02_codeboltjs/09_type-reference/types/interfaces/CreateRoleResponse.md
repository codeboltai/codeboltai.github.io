...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `role`: [`Role`](Role); \} | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:271 |
| `data.role` | [`Role`](Role) | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:271 |
