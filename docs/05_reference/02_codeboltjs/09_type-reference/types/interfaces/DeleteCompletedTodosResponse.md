---
title: DeleteCompletedTodosResponse
---
...
# Interface: DeleteCompletedTodosResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:127
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="count"></a> `count?` | `number` | Number of todos deleted | - | common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:129 |
...
| <a id="ids"></a> `ids?` | `string`[] | Deleted todo IDs | - | common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:131 |
