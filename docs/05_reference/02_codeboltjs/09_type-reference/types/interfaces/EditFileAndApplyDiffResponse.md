...
| ------ | ------ | ------ | ------ |
| <a id="applymodel"></a> `applyModel?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:134 |
| <a id="diff"></a> `diff?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:131 |
| <a id="diffidentifier"></a> `diffIdentifier?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:132 |
...
| <a id="filepath"></a> `filePath?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:130 |
...
| <a id="prompt"></a> `prompt?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:133 |
| <a id="result"></a> `result?` | \| `string` \| \{ `file`: `string`; `message`: `string`; `status`: `"success"` \| `"error"` \| `"review_started"` \| `"rejected"`; \} | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:135 |
