...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `agents`: [`SwarmAgent`](SwarmAgent)[]; \} | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:306 |
| `data.agents` | [`SwarmAgent`](SwarmAgent)[] | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:306 |
