---
title: GetAvailableToolBoxesResponse
---
...
# Interface: GetAvailableToolBoxesResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/mcp.ts:88
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `enabled`: `boolean`; `name`: `string`; `tools?`: \{ `description?`: `string`; `name`: `string`; `parameters?`: `Record`\<`string`, `unknown`\>; \}[]; \}[] | - | common/types/src/codeboltjstypes/libFunctionTypes/mcp.ts:89 |
