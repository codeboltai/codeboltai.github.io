...
| ------ | ------ | ------ | ------ |
| <a id="content"></a> `content?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/browser.ts:76 |
...
| <a id="html"></a> `html?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/browser.ts:77 |
...
| <a id="text"></a> `text?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/browser.ts:78 |
