...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/mcp.ts:160
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `description?`: `string`; `name`: `string`; `parameters?`: `Record`\<`string`, `unknown`\>; \}[] | - | common/types/src/codeboltjstypes/libFunctionTypes/mcp.ts:161 |
