...
# Interface: GetOrchestratorResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/orchestrator.ts:101
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`OrchestratorInstance`](OrchestratorInstance) | - | common/types/src/codeboltjstypes/libFunctionTypes/orchestrator.ts:103 |
...
| <a id="requestid"></a> `requestId?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/orchestrator.ts:102 |
