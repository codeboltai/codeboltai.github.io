...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/actionPlan.ts:96
...
| <a id="plan"></a> `plan?` | [`ActionPlanDetail`](ActionPlanDetail) | - | common/types/src/codeboltjstypes/libFunctionTypes/actionPlan.ts:97 |
