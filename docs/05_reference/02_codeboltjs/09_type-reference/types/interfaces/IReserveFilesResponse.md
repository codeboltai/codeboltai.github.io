...
# Interface: IReserveFilesResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:155
...
| <a id="error"></a> `error?` | `string` | [`BaseApplicationResponse`](BaseApplicationResponse).[`error`](BaseApplicationResponse.md#error) | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:159 |
...
| <a id="reservationid"></a> `reservationId?` | `string` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:158 |
| <a id="reserved"></a> `reserved?` | `boolean` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:157 |
| <a id="success"></a> `success?` | `boolean` | [`BaseApplicationResponse`](BaseApplicationResponse).[`success`](BaseApplicationResponse.md#success) | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:156 |
