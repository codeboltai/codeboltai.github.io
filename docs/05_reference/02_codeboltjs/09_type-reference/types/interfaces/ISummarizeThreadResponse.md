---
title: ISummarizeThreadResponse
---
...
# Interface: ISummarizeThreadResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:141
...
| <a id="error"></a> `error?` | `string` | [`BaseApplicationResponse`](BaseApplicationResponse).[`error`](BaseApplicationResponse.md#error) | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:144 |
...
| <a id="success"></a> `success?` | `boolean` | [`BaseApplicationResponse`](BaseApplicationResponse).[`success`](BaseApplicationResponse.md#success) | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:142 |
| <a id="summary"></a> `summary?` | `string` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:143 |
