...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:109
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `exists`: `boolean`; `value`: `any`; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:110 |
| `data.exists` | `boolean` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:110 |
| `data.value` | `any` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:110 |
