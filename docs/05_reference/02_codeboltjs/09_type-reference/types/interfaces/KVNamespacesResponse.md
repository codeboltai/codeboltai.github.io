...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:129
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `namespaces`: `string`[]; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:130 |
| `data.namespaces` | `string`[] | - | - | common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:130 |
