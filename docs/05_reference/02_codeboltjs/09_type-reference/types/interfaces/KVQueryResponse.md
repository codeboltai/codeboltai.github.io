...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `result`: [`KVQueryResult`](KVQueryResult); \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:126 |
| `data.result` | [`KVQueryResult`](KVQueryResult) | - | - | common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:126 |
