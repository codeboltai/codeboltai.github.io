...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `record`: [`KVRecord`](KVRecord); \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:114 |
| `data.record` | [`KVRecord`](KVRecord) | - | - | common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:114 |
