...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:326
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `vacancies`: [`Vacancy`](Vacancy)[]; \} | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:327 |
| `data.vacancies` | [`Vacancy`](Vacancy)[] | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:327 |
