...
# Interface: MemoryExistsResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:136
...
| <a id="exists"></a> `exists?` | `boolean` | Whether the key exists | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:139 |
| <a id="key"></a> `key?` | `string` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:137 |
...
| <a id="metadata"></a> `metadata?` | `Record`\<`string`, `unknown`\> | Exists check metadata | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:141 |
