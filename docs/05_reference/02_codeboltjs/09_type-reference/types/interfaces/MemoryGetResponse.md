...
| ------ | ------ | ------ | ------ | ------ |
| <a id="entry"></a> `entry?` | [`MemoryEntry`](MemoryEntry) | Memory entry data | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:98 |
...
| <a id="key"></a> `key?` | `string` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:95 |
...
| <a id="metadata"></a> `metadata?` | `Record`\<`string`, `unknown`\> | Get operation metadata | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:100 |
...
| <a id="value"></a> `value?` | [`MemoryValue`](../type-aliases/MemoryValue) | - | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:96 |
