...
| <a id="metadata"></a> `metadata?` | `Record`\<`string`, `unknown`\> | Search operation metadata | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:133 |
| <a id="query"></a> `query?` | `string` | Search query | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:129 |
...
| <a id="results"></a> `results?` | [`MemorySearchResult`](MemorySearchResult) | Search results | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:131 |
