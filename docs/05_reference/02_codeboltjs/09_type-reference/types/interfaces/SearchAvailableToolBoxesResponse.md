---
title: SearchAvailableToolBoxesResponse
---
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | `Record`\<`string`, \{ `description?`: `string`; `name`: `string`; `tools?`: \{ `description?`: `string`; `name`: `string`; `parameters?`: `Record`\<`string`, `unknown`\>; \}[]; \}\> | - | common/types/src/codeboltjstypes/libFunctionTypes/mcp.ts:101 |
