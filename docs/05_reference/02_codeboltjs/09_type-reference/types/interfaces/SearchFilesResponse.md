...
| <a id="hasmore"></a> `hasMore?` | `boolean` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:94 |
...
| <a id="path"></a> `path?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:96 |
| <a id="query"></a> `query?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:81 |
| <a id="results"></a> `results?` | \{ `matches`: \{ `content`: `string`; `endIndex?`: `number`; `line`: `number`; `lineNumber`: `number`; `startIndex?`: `number`; \}[]; `path`: `string`; `stats?`: `any`; \}[] | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:82 |
| <a id="searchtime"></a> `searchTime?` | `number` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:95 |
...
| <a id="totalcount"></a> `totalCount?` | `number` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:93 |
