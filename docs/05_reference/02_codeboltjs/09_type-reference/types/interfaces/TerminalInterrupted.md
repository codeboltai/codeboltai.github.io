...
| <a id="interrupted"></a> `interrupted` | `boolean` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/terminal.ts:44 |
...
| <a id="type"></a> `type?` | `"terminalInterrupted"` | [`BaseTerminalSDKResponse`](BaseTerminalSDKResponse).[`type`](BaseTerminalSDKResponse.md#type) | - | common/types/src/codeboltjstypes/libFunctionTypes/terminal.ts:43 |
