...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:63
...
| <a id="todo"></a> `todo?` | [`TodoItem`](TodoItem) | Updated todo item | - | common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:65 |
