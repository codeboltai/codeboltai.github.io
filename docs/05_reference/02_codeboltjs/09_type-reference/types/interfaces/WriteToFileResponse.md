...
# Interface: WriteToFileResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:99
...
| ------ | ------ | ------ | ------ |
| <a id="byteswritten"></a> `bytesWritten?` | `number` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:101 |
...
| <a id="result"></a> `result?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:100 |
