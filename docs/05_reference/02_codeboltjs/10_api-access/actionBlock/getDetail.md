...
- **`Promise<[GetActionBlockDetailResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/GetActionBlockDetailResponse)>`**: A promise that resolves to ActionBlock details.

### Response Structure

Returns [`GetActionBlockDetailResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/GetActionBlockDetailResponse) with detailed ActionBlock information.
