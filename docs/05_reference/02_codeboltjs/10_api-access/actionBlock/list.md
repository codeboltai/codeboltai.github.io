...
- **`filter`** ([ActionBlockFilter](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ActionBlockFilter), optional): Optional filter to narrow results by type (filesystem, runtime, or builtin).

### Returns

- **`Promise<[ListActionBlocksResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ListActionBlocksResponse)>`**: A promise that resolves to the list of ActionBlocks.

### Response Structure

Returns [`ListActionBlocksResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ListActionBlocksResponse) with array of ActionBlocks.
