...
- **`Promise<AgentsDetailResponse>`**: A promise that resolves with an [`AgentsDetailResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/AgentsDetailResponse) object containing the detailed information of the specified agents.

### Response Structure

The method returns a Promise that resolves to an [`AgentsDetailResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/AgentsDetailResponse) object with the following properties:
