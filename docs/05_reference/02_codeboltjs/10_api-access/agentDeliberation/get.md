...
- **`params`** ([IGetDeliberationParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IGetDeliberationParams)): Parameters including deliberation ID and optional view type.

### Returns

- **`Promise<[IGetDeliberationResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IGetDeliberationResponse)>`**: A promise that resolves to deliberation details.
