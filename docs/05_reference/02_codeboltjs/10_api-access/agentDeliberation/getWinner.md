...
- **`params`** ([IGetWinnerParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IGetWinnerParams)): Parameters including the deliberation ID.

### Returns

- **`Promise<[IGetWinnerResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IGetWinnerResponse)>`**: A promise that resolves to the winning response and vote details.
