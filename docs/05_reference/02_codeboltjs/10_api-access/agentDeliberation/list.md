...
- **`params`** ([IListDeliberationsParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IListDeliberationsParams), optional): Optional filters for the deliberation list.

### Returns

- **`Promise<[IListDeliberationsResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IListDeliberationsResponse)>`**: A promise that resolves to the list of deliberations.
