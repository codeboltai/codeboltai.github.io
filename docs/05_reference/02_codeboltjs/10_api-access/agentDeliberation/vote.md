...
- **`params`** ([IVoteParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IVoteParams)): Parameters including deliberation ID, response ID, and voter info.

### Returns

- **`Promise<[IVoteResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IVoteResponse)>`**: A promise that resolves to the cast vote.
