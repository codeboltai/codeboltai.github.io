...
- **`Promise<[AddAppreciationResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/AddAppreciationResponse)>`**: A promise that resolves when appreciation is added.
