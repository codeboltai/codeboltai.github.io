...
- **`Promise<[AddTalentResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/AddTalentResponse)>`**: A promise that resolves when talent is added.
