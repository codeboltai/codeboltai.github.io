...
- **`Promise<[DeleteTestimonialResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/DeleteTestimonialResponse)>`**: A promise that resolves when testimonial is deleted.
