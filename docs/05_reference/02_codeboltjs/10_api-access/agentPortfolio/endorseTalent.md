...
- **`Promise<[EndorseTalentResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/EndorseTalentResponse)>`**: A promise that resolves when talent is endorsed.
