...
- **`Promise<[GetKarmaHistoryResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/GetKarmaHistoryResponse)>`**: A promise that resolves to the karma history.
