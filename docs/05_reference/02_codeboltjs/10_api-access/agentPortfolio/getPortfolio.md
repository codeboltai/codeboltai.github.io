...
- **`Promise<[GetPortfolioResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/GetPortfolioResponse)>`**: A promise that resolves to the agent's complete portfolio data.

### Response Structure

Returns a [`GetPortfolioResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/GetPortfolioResponse) with comprehensive agent portfolio data.
