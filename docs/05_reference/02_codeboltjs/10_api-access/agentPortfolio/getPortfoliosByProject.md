...
- **`Promise<[GetPortfoliosByProjectResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/GetPortfoliosByProjectResponse)>`**: A promise that resolves to the list of portfolios.
