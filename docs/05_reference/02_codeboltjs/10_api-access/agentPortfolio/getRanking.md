...
- **`Promise<[GetRankingResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/GetRankingResponse)>`**: A promise that resolves to the ranking list.

### Response Structure

Returns a [`GetRankingResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/GetRankingResponse) with ranking data.
