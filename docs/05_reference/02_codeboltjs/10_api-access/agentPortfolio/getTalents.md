...
- **`Promise<[GetTalentsResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/GetTalentsResponse)>`**: A promise that resolves to the list of talents.
