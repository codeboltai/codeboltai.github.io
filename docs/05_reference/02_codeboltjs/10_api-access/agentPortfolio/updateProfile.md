...
- **`Promise<[UpdateProfileResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/UpdateProfileResponse)>`**: A promise that resolves to the updated profile.
