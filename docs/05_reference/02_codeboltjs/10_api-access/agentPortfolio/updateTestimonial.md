...
- **`Promise<[UpdateTestimonialResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/UpdateTestimonialResponse)>`**: A promise that resolves to the updated testimonial.
