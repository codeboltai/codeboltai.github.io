...
- **`params`** ([ICreateRunParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ICreateRunParams)): Parameters including test suite ID and optional run name.

### Returns

- **`Promise<[ICreateRunResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ICreateRunResponse)>`**: A promise that resolves to the created test run.
