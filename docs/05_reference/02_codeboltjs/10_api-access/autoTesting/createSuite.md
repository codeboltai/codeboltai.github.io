...
- **`params`** ([ICreateSuiteParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ICreateSuiteParams)): Parameters for creating the test suite.

### Returns

- **`Promise<[ICreateSuiteResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ICreateSuiteResponse)>`**: A promise that resolves to the created test suite.
