...
- **`params`** ([IDeleteSuiteParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IDeleteSuiteParams)): Parameters including the suite ID to delete.

### Returns

- **`Promise<[IDeleteSuiteResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IDeleteSuiteResponse)>`**: A promise that resolves when the suite is deleted.
