...
- **`params`** ([IGetCaseParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IGetCaseParams)): Parameters including the case ID.

### Returns

- **`Promise<[IGetCaseResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IGetCaseResponse)>`**: A promise that resolves to the test case details.
