...
- **`params`** ([IGetRunParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IGetRunParams)): Parameters including the run ID.

### Returns

- **`Promise<[IGetRunResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IGetRunResponse)>`**: A promise that resolves to the test run with detailed results.
