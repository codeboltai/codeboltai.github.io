...
- **`params`** ([IGetSuiteParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IGetSuiteParams)): Parameters including the suite ID.

### Returns

- **`Promise<[IGetSuiteResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IGetSuiteResponse)>`**: A promise that resolves to the test suite with associated test cases.
