...
- **`params`** ([IListRunsParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IListRunsParams), optional): Optional parameters including suite ID for filtering.

### Returns

- **`Promise<[IListRunsResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IListRunsResponse)>`**: A promise that resolves to the list of test runs.
