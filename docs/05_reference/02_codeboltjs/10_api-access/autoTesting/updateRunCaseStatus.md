...
- **`params`** ([IUpdateRunCaseParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IUpdateRunCaseParams)): Parameters including run ID, case ID, status, and optional user override flag.

### Returns

- **`Promise<[IUpdateRunCaseResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IUpdateRunCaseResponse)>`**: A promise that resolves to the updated test run.
