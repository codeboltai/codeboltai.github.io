...
- **`params`** ([IUpdateRunStatusParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IUpdateRunStatusParams)): Parameters including run ID and new status.

### Returns

- **`Promise<[IUpdateRunStatusResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IUpdateRunStatusResponse)>`**: A promise that resolves to the updated test run.
