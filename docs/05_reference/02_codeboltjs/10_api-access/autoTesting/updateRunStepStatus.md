...
- **`params`** ([IUpdateRunStepParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IUpdateRunStepParams)): Parameters including run ID, case ID, step ID, status, logs, and user override flag.

### Returns

- **`Promise<[IUpdateRunStepResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IUpdateRunStepResponse)>`**: A promise that resolves to the updated test run.
