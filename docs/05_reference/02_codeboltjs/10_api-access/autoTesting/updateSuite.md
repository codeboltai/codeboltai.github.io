...
- **`params`** ([IUpdateSuiteParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IUpdateSuiteParams)): Parameters including suite ID and fields to update.

### Returns

- **`Promise<[IUpdateSuiteResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IUpdateSuiteResponse)>`**: A promise that resolves to the updated suite.
