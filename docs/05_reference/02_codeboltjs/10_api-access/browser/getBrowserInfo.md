...
The method returns a Promise that resolves to a [`BrowserInfoResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/BrowserInfoResponse) object with the following properties:
