...
The method returns a Promise that resolves to a [`GetContentResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/GetContentResponse) object with the following properties:
