...
The method returns a Promise that resolves to a [`GetMarkdownResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/GetMarkdownResponse) object with the following properties:
