...
The method returns a Promise that resolves to a [`BrowserSnapshotResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/BrowserSnapshotResponse) object with the following properties:
