...
The method returns a Promise that resolves to a [`GoToPageResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/GoToPageResponse) object with the following properties:
