...
- **options** ([`BrowserInstanceOptions`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/BrowserInstanceOptions), optional): Configuration options for the new instance
...
- [`getBrowserInstance()`](/docs/reference/codeboltjs/api-access/browser/getInstance) - Get specific instance
