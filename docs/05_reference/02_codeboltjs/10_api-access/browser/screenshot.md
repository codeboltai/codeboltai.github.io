...
The method returns a Promise that resolves to a [`BrowserScreenshotResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/BrowserScreenshotResponse) object with the following properties:
