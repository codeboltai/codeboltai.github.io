...
- **`params`** ([ICreateEventParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ICreateEventParams)): Event creation parameters including title, time, type, and optional settings

### Returns

- **`Promise<[ICreateEventResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ICreateEventResponse)>`**: A promise that resolves to the created event data

### Parameter Details

The [`ICreateEventParams`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ICreateEventParams) interface includes:
