...
- **`params`** ([IListEventsParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IListEventsParams)): Optional filter parameters for querying events

### Returns

- **`Promise<[IListEventsResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IListEventsResponse)>`**: A promise that resolves to a list of filtered events with count

### Parameter Details

The [`IListEventsParams`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IListEventsParams) interface includes all optional fields:
