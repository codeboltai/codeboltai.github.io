...
- **`params`** ([IUpdateEventParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IUpdateEventParams)): Event update parameters including eventId and fields to update

### Returns

- **`Promise<[IUpdateEventResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IUpdateEventResponse)>`**: A promise that resolves to the updated event data

### Parameter Details

The [`IUpdateEventParams`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IUpdateEventParams) interface includes:
