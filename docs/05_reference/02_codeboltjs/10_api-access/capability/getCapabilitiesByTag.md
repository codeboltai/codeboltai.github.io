...
- **`Promise<[ListCapabilitiesResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ListCapabilitiesResponse)>`**: A promise that resolves to a list of capabilities with the specified tag.

### Response Structure

Returns a [`ListCapabilitiesResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ListCapabilitiesResponse) with capabilities matching the tag.
