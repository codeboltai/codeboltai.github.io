...
- **`capabilityType`** ([CapabilityType](/docs/reference/codeboltjs/type-reference/codeboltjs/type-aliases/CapabilityType), optional): Optional type to narrow the search and ensure correct capability retrieval.

### Returns

- **`Promise<[GetCapabilityDetailResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/GetCapabilityDetailResponse)>`**: A promise that resolves to detailed information about the specified capability.

### Response Structure

The method returns a Promise that resolves to a [`GetCapabilityDetailResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/GetCapabilityDetailResponse) object with the following properties:
