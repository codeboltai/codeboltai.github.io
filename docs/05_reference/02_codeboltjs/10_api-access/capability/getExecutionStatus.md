...
- **`Promise<[GetExecutionStatusResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/GetExecutionStatusResponse)>`**: A promise that resolves to the current execution status.

### Response Structure

The method returns a Promise that resolves to a [`GetExecutionStatusResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/GetExecutionStatusResponse) object.
