...
- **`capabilityType`** ([CapabilityType](/docs/reference/codeboltjs/type-reference/codeboltjs/type-aliases/CapabilityType)): The type of capability (skill, power, talent, etc.).
...
- **`Promise<[StartCapabilityResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/StartCapabilityResponse)>`**: A promise that resolves to the execution response containing the execution ID and initial status.

### Response Structure

The method returns a Promise that resolves to a [`StartCapabilityResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/StartCapabilityResponse) object with the following properties:
