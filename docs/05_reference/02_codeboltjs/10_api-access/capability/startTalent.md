...
The method returns a Promise that resolves to a [`StartCapabilityResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/StartCapabilityResponse) object.
