...
The method returns a Promise that resolves to an [`AddToAgentStateResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/AddToAgentStateResponse) object with the following properties:
