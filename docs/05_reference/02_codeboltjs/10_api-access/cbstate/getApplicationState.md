...
The method returns a Promise that resolves to a [`GetAppStateResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/GetAppStateResponse) object with the following properties:
