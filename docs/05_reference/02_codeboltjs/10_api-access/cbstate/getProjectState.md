...
The method returns a Promise that resolves to a [`GetProjectStateResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/GetProjectStateResponse) object with the following properties:
