...
- **`Promise<getMatchDetail>`**: A promise that resolves with a [`getMatchDetail`](/docs/reference/codeboltjs/type-reference/types/interfaces/getMatchDetail) object containing the detailed matcher configuration including patterns and rules.

### Response Structure

The method returns a Promise that resolves to a [`getMatchDetail`](/docs/reference/codeboltjs/type-reference/types/interfaces/getMatchDetail) object with the following properties:
