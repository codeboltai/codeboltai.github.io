...
- **`Promise<[RuleEvaluationResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/RuleEvaluationResponse)>`**: A promise that resolves with rule evaluation results.
