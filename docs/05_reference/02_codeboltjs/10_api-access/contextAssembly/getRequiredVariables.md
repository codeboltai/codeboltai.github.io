...
- **`Promise<[RequiredVariablesResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/RequiredVariablesResponse)>`**: A promise that resolves with required variable information.
