...
- **`Promise<[MemoryTypesResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/MemoryTypesResponse)>`**: A promise that resolves with available memory types.
