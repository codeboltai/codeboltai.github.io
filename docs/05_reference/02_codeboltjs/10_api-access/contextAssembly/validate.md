...
- **`Promise<[ContextValidateResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ContextValidateResponse)>`**: A promise that resolves with validation results.
