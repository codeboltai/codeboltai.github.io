...
- **`Promise<[ContextRuleEngineResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ContextRuleEngineResponse)>`**: A promise that resolves with the created rule engine details.
