...
- **`Promise<[ContextRuleEngineDeleteResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ContextRuleEngineDeleteResponse)>`**: A promise that resolves with deletion status.
