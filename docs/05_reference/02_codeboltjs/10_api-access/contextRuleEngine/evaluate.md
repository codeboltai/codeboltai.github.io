...
- **`Promise<[EvaluateRulesResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/EvaluateRulesResponse)>`**: A promise that resolves with evaluation results.
