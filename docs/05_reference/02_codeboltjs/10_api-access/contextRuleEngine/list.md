...
- **`Promise<[ContextRuleEngineListResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ContextRuleEngineListResponse)>`**: A promise that resolves with an array of all rule engines.
