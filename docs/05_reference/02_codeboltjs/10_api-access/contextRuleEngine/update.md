...
- **`Promise<[ContextRuleEngineResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ContextRuleEngineResponse)>`**: A promise that resolves with the updated rule engine.
