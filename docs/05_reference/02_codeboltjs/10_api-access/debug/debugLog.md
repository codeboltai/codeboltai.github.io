...
- **`Promise<DebugAddLogResponse>`**: A promise that resolves with a [`DebugAddLogResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/DebugAddLogResponse) object containing the response type and log metadata.

### Response Structure

The method returns a Promise that resolves to a [`DebugAddLogResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/DebugAddLogResponse) object with the following properties:
