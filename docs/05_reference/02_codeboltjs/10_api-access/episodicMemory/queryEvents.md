...
- **`params`** ([IQueryEventsParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IQueryEventsParams)): Query parameters with optional filters.

### Returns

- **`Promise<[IQueryEventsResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IQueryEventsResponse)>`**: A promise that resolves to filtered events.
