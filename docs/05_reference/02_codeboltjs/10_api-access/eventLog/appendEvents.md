...
- **`Promise<[EventLogAppendMultipleResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/EventLogAppendMultipleResponse)>`**: A promise that resolves with all appended events and count.
