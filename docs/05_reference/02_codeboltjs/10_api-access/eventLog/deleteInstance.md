...
- **`Promise<[EventLogInstanceResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/EventLogInstanceResponse)>`**: A promise that resolves when the instance is deleted.
