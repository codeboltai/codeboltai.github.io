...
- **`Promise<[EventLogStatsResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/EventLogStatsResponse)>`**: A promise that resolves with instance statistics.
