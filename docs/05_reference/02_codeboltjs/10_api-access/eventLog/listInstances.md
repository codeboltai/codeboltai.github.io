...
- **`Promise<[EventLogInstanceListResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/EventLogInstanceListResponse)>`**: A promise that resolves with an array of all event log instances.
