...
- **`Promise<[EventLogQueryResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/EventLogQueryResponse)>`**: A promise that resolves with matching events or aggregations.
