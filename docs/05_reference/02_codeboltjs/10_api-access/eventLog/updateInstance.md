...
- **`Promise<[EventLogInstanceResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/EventLogInstanceResponse)>`**: A promise that resolves with the updated instance details.
