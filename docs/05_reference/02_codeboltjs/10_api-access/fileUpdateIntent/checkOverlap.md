...
- **`Promise<[IntentOverlapResult](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IntentOverlapResult)>`**: A promise that resolves with overlap information.
