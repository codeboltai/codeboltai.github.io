...
- **`Promise<[FileUpdateIntent](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/FileUpdateIntent)>`**: A promise that resolves with the intent details.
