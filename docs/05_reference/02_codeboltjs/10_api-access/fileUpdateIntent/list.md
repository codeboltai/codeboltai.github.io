...
- **`Promise<[FileUpdateIntent](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/FileUpdateIntent)[]>`**: A promise that resolves with an array of file update intents.
