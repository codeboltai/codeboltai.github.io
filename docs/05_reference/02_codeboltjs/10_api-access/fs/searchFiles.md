...
The method returns a Promise that resolves to a [`SearchFilesResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/SearchFilesResponse) object with the following properties:
