...
- **`Promise<GitCheckoutResponse>`**: A promise that resolves with a [`GitCheckoutResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/GitCheckoutResponse) object containing the checkout operation results.

### Response Structure

The method returns a Promise that resolves to a [`GitCheckoutResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/GitCheckoutResponse) object with the following properties:
