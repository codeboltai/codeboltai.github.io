...
The method returns a Promise that resolves to a [`GitCloneResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/GitCloneResponse) object with the following properties:
