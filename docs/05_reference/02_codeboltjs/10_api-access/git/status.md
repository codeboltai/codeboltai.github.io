...
- **`Promise<GitStatusResponse>`**: A promise that resolves with a [`GitStatusResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/GitStatusResponse) object containing the git status information and repository state.

### Response Structure

The method returns a Promise that resolves to a [`GitStatusResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/GitStatusResponse) object with the following properties:
