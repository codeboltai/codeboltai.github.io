...
- **`params`** ([ICreateFeedbackParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ICreateFeedbackParams)): Feedback session parameters including title, description, participants, questions, and metadata.

### Returns

- **`Promise<[ICreateFeedbackResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ICreateFeedbackResponse)>`**: A promise that resolves with the created feedback session details.
