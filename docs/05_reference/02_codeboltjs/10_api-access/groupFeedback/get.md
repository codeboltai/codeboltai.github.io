...
- **`params`** ([IGetFeedbackParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IGetFeedbackParams)): Parameters including the feedbackId to retrieve.

### Returns

- **`Promise<[IGetFeedbackResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IGetFeedbackResponse)>`**: A promise that resolves with the feedback session details.
