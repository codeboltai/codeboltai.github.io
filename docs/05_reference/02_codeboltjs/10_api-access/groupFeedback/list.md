...
- **`params`** ([IListFeedbacksParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IListFeedbacksParams)): Optional filters including status, participantId, limit, and offset.

### Returns

- **`Promise<[IListFeedbacksResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IListFeedbacksResponse)>`**: A promise that resolves with an array of feedback sessions.
