...
- **`params`** ([IUpdateStatusParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IUpdateStatusParams)): Parameters including feedbackId and the new status value.

### Returns

- **`Promise<[IUpdateStatusResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IUpdateStatusResponse)>`**: A promise that resolves with the updated status.
