...
- **`Promise<[HookResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/HookResponse)>`**: A promise that resolves with the enabled hook details.
