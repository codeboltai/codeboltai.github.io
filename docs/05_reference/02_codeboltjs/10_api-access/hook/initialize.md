...
- **`Promise<[HookInitializeResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/HookInitializeResponse)>`**: A promise that resolves when the hook manager is initialized.
