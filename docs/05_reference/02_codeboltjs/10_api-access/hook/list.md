...
- **`Promise<[HookListResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/HookListResponse)>`**: A promise that resolves with an array of all hooks.
