...
- **`data`** ([CreateJobData](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/CreateJobData)): The job data including name, type, priority, and optional fields.

### Returns

- **`Promise<[JobCreateResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/JobCreateResponse)>`**: A promise that resolves with the created job.
