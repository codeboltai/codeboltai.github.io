...
- [Knowledge Graph](/docs/reference/codeboltjs/api-access/knowledgeGraph) - Graph-based knowledge representation
- [Persistent Memory](/docs/reference/codeboltjs/api-access/persistentMemory) - Long-term memory storage
- [RAG](/docs/reference/codeboltjs/api-access/rag) - Retrieval-augmented generation
- [Memory](/docs/reference/codeboltjs/api-access/memory) - General memory operations
- [VectorDB](/docs/reference/codeboltjs/api-access/vectordb) - Vector database for semantic search
