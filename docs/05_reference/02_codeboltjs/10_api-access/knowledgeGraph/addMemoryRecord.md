...
- **`record`** ([CreateKGMemoryRecordParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/CreateKGMemoryRecordParams)): Record data object.

### Returns

- **`Promise<[KGMemoryRecordResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/KGMemoryRecordResponse)>`**: A promise that resolves to the created record details.
