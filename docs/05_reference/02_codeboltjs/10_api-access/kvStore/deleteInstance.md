...
- **`Promise<[KVDeleteResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/KVDeleteResponse)>`**: A promise that resolves with the deletion status.

### Response Structure

The method returns a Promise that resolves to a [`KVDeleteResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/KVDeleteResponse) object:
