...
- **`Promise<[KVDeleteNamespaceResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/KVDeleteNamespaceResponse)>`**: A promise that resolves with the number of deleted records.

### Response Structure

The method returns a Promise that resolves to a [`KVDeleteNamespaceResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/KVDeleteNamespaceResponse) object:
