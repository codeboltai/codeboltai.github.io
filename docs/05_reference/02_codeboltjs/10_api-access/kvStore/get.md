...
- **`Promise<[KVGetResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/KVGetResponse)>`**: A promise that resolves with the value and existence status.

### Response Structure

The method returns a Promise that resolves to a [`KVGetResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/KVGetResponse) object:
