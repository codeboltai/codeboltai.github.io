...
- **`Promise<[KVNamespacesResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/KVNamespacesResponse)>`**: A promise that resolves with an array of namespace names.

### Response Structure

The method returns a Promise that resolves to a [`KVNamespacesResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/KVNamespacesResponse) object:
