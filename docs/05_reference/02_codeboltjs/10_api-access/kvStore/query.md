...
- **`Promise<[KVQueryResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/KVQueryResponse)>`**: A promise that resolves with matching records and pagination metadata.

### Response Structure

The method returns a Promise that resolves to a [`KVQueryResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/KVQueryResponse) object:
