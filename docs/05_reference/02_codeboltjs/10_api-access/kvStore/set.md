...
- **`Promise<[KVSetResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/KVSetResponse)>`**: A promise that resolves with the stored record details including timestamps.

### Response Structure

The method returns a Promise that resolves to a [`KVSetResponse`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/KVSetResponse) object:
