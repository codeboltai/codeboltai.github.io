...
- **`Promise<[KVInstanceResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/KVInstanceResponse)>`**: A promise that resolves with the updated instance details.
