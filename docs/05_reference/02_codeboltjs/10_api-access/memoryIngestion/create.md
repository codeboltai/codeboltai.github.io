...
- **`config`** ([CreateIngestionPipelineParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/CreateIngestionPipelineParams)): Pipeline configuration object.

### Returns

- **`Promise<[IngestionPipelineResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IngestionPipelineResponse)>`**: A promise that resolves to the created pipeline details.
