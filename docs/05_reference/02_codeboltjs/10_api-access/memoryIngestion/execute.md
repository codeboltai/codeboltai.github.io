...
- **`params`** ([ExecuteIngestionParams](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ExecuteIngestionParams)): Execution parameters containing pipeline ID and data.

### Returns

- **`Promise<[IngestionExecuteResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/IngestionExecuteResponse)>`**: A promise that resolves to execution results.
