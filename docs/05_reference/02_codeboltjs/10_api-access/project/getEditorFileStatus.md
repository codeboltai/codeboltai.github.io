...
The method returns a Promise that resolves to a [`GetEditorFileStatusResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/GetEditorFileStatusResponse) object with the following properties:
