...
The method returns a Promise that resolves to a [`GetProjectSettingsResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/GetProjectSettingsResponse) object with the following properties:
