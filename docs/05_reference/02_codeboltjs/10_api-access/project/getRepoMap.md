...
The method returns a Promise that resolves to a [`GetRepoMapResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/GetRepoMapResponse) object with the following properties:
