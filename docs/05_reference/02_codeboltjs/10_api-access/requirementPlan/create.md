...
- **`Promise<[RequirementPlanCreateResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/RequirementPlanCreateResponse)>`**: A promise that resolves to creation result with file path
