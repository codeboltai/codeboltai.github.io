...
- **`Promise<[RequirementPlanGetResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/RequirementPlanGetResponse)>`**: A promise that resolves to the plan document
