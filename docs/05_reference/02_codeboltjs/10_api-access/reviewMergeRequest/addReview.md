...
- **`feedback`** ([AddReviewFeedback](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/AddReviewFeedback)): Review feedback including agent info, type, and comment

### Returns

- **`Promise<{ request: [ReviewMergeRequest](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ReviewMergeRequest) }>`**: A promise that resolves to the updated request with new review
