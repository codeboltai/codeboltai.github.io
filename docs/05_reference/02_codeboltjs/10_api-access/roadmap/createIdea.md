...
- **`data`** ([CreateIdeaData](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/CreateIdeaData)): Idea data including title, description, and optional metadata
- **`projectPath`** (string): Optional project path (uses active project if not provided)

### Returns

- **`Promise<[RoadmapIdeaResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/RoadmapIdeaResponse)>`**: A promise that resolves to the created idea

### Parameter Details

The [`CreateIdeaData`](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/CreateIdeaData) interface includes:
