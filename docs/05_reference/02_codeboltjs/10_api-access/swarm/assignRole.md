...
- **`Promise<[AssignRoleResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/AssignRoleResponse)>`**: A promise that resolves when the role is assigned.
