...
- **`data`** ([CreateRoleRequest](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/CreateRoleRequest)): Role creation configuration.

### Returns

- **`Promise<[CreateRoleResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/CreateRoleResponse)>`**: A promise that resolves to the created role details.
