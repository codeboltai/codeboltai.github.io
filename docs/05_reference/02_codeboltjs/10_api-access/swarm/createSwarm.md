...
- **`data`** ([CreateSwarmRequest](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/CreateSwarmRequest)): Configuration object for the new swarm.

### Returns

- **`Promise<[CreateSwarmResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/CreateSwarmResponse)>`**: A promise that resolves to the created swarm details.
