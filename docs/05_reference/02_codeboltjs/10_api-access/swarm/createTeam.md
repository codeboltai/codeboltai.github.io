...
- **`data`** ([CreateTeamRequest](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/CreateTeamRequest)): Team creation configuration.

### Returns

- **`Promise<[CreateTeamResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/CreateTeamResponse)>`**: A promise that resolves to the created team details.
