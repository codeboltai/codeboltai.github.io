...
- **`Promise<[ListSwarmsResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/ListSwarmsResponse)>`**: A promise that resolves to an array of all swarms.
