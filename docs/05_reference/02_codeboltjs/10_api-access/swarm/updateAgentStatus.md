...
- **`data`** ([AgentStatusUpdate](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/AgentStatusUpdate)): Status update information.

### Returns

- **`Promise<[UpdateStatusResponse](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/UpdateStatusResponse)>`**: A promise that resolves when the status is updated.
