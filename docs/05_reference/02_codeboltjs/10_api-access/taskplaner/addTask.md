...
The method returns a Promise that resolves to an [`AddTaskResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/AddTaskResponse) object with the following properties:
