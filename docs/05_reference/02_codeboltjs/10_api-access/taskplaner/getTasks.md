...
The method returns a Promise that resolves to a [`GetTasksResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/GetTasksResponse) object with the following properties:
