...
The method returns a Promise that resolves to either a [`CommandFinish`](/docs/reference/codeboltjs/type-reference/types/interfaces/CommandFinish) or [`CommandError`](/docs/reference/codeboltjs/type-reference/types/interfaces/CommandError) object:
...
- Always handle both success ([`CommandFinish`](/docs/reference/codeboltjs/type-reference/types/interfaces/CommandFinish)) and error ([`CommandError`](/docs/reference/codeboltjs/type-reference/types/interfaces/CommandError)) response types
