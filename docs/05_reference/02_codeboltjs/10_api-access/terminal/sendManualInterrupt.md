...
The method returns a Promise that resolves to a [`TerminalInterruptResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/TerminalInterruptResponse) object with the following properties:
