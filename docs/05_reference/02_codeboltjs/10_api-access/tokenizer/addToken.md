...
- **`Promise<AddTokenResponse>`**: A promise that resolves with an [`AddTokenResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/AddTokenResponse) object containing the tokenization response.

### Response Structure

The method returns a Promise that resolves to an [`AddTokenResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/AddTokenResponse) object with the following properties:
