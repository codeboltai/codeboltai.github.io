...
- **`Promise<ExecuteToolResponse>`**: A promise that resolves with an [`ExecuteToolResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/ExecuteToolResponse) object containing the tool execution result.

### Response Structure

The method returns a Promise that resolves to an [`ExecuteToolResponse`](/docs/reference/codeboltjs/type-reference/types/interfaces/ExecuteToolResponse) object with the following properties:
