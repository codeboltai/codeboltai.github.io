...
- **`userMessage`** ([UserMessage](/docs/reference/codeboltjs/type-reference/codeboltjs/interfaces/UserMessage)): Message object containing user input with toolbox mentions in mentionedMCPs array
