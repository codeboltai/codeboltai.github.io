...
Environment Debug WebSocket - Debug environment sessions with subscribe support.
Subscribe-based: list, get, get-logs, subscribe/unsubscribe for session events.
Additional events: state-changed, health-check.

## Extends

- [`TypedEventEmitter`](TypedEventEmitter)\<`EnvironmentDebugSocketEvents`\>
...
Defined in: CodeBolt/packages/pluginSdk/src/sockets/environment-debug.socket.ts:104
...
Defined in: CodeBolt/packages/pluginSdk/src/sockets/environment-debug.socket.ts:107
...
Defined in: CodeBolt/packages/pluginSdk/src/sockets/environment-debug.socket.ts:101
...
| ------ | ------ |
| `event` | `K` |
| `listener` | `EnvironmentDebugSocketEvents`\[`K`\] |
...
Defined in: CodeBolt/packages/pluginSdk/src/sockets/environment-debug.socket.ts:116
...
Defined in: CodeBolt/packages/pluginSdk/src/sockets/environment-debug.socket.ts:110
...
Defined in: CodeBolt/packages/pluginSdk/src/sockets/environment-debug.socket.ts:113
