...
Defined in: CodeBolt/packages/pluginSdk/src/sockets/local-model.socket.ts:9
...
Defined in: CodeBolt/packages/pluginSdk/src/sockets/local-model.socket.ts:12
...
Defined in: CodeBolt/packages/pluginSdk/src/sockets/local-model.socket.ts:78
