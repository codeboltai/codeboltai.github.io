...
cbapicategory:
  - name: addChild
    link: /docs/reference/client-sdk/api-reference/tasks/addChild
...
that contribute to completing the parent task. Returns the new child task."
  - name: addMessage
    link: /docs/reference/client-sdk/api-reference/tasks/addMessage
...
communication related to the task. Returns the created message."
  - name: create
    link: /docs/reference/client-sdk/api-reference/tasks/create
...
a task hierarchy. Returns the created task with its generated ID."
  - name: delete
    link: /docs/reference/client-sdk/api-reference/tasks/delete
...
This operation cannot be undone."
  - name: deleteCompletedTasks
    link: /docs/reference/client-sdk/api-reference/tasks/deleteCompletedTasks
...
Use with caution as this operation cannot be undone."
  - name: deleteProjectCompletedTasks
    link: /docs/reference/client-sdk/api-reference/tasks/deleteProjectCompletedTasks
...
history. This operation cannot be undone."
  - name: get
    link: /docs/reference/client-sdk/api-reference/tasks/get
...
when you need the complete task representation."
  - name: getChildren
    link: /docs/reference/client-sdk/api-reference/tasks/getChildren
...
for navigation of the task hierarchy."
  - name: getForCurrentProject
    link: /docs/reference/client-sdk/api-reference/tasks/getForCurrentProject
...
operate on tasks within the current working project."
  - name: getForProject
    link: /docs/reference/client-sdk/api-reference/tasks/getForProject
...
current working directory context."
  - name: getHierarchy
    link: /docs/reference/client-sdk/api-reference/tasks/getHierarchy
...
comprehensive analysis."
  - name: getProjectStatistics
    link: /docs/reference/client-sdk/api-reference/tasks/getProjectStatistics
...
project-specific metrics. Ideal for project dashboards."
  - name: getStatistics
    link: /docs/reference/client-sdk/api-reference/tasks/getStatistics
...
high-level reporting on task activity across the entire platform."
  - name: healthCheck
    link: /docs/reference/client-sdk/api-reference/tasks/healthCheck
...
production environments."
  - name: markCompleted
    link: /docs/reference/client-sdk/api-reference/tasks/markCompleted
...
achieved. Returns the updated task object."
  - name: markFailed
    link: /docs/reference/client-sdk/api-reference/tasks/markFailed
...
when task objectives cannot be achieved. Returns the updated task object."
  - name: markInProgress
    link: /docs/reference/client-sdk/api-reference/tasks/markInProgress
...
Returns the updated task object."
  - name: search
    link: /docs/reference/client-sdk/api-reference/tasks/search
...
ranges, or custom filters. Returns an empty array if no tasks match."
  - name: update
    link: /docs/reference/client-sdk/api-reference/tasks/update
