...
cbapicategory:
  - name: advancedSearch
    link: /docs/reference/client-sdk/api-reference/threads/advancedSearch
...
and management operations."
  - name: autoUpdateName
    link: /docs/reference/client-sdk/api-reference/threads/autoUpdateName
...
for maintaining descriptive thread labels without manual intervention."
  - name: bulkDelete
    link: /docs/reference/client-sdk/api-reference/threads/bulkDelete
...
atomic deletion of multiple threads."
  - name: bulkUpdate
    link: /docs/reference/client-sdk/api-reference/threads/bulkUpdate
...
to apply the same changes to many threads."
  - name: cancel
    link: /docs/reference/client-sdk/api-reference/threads/cancel
...
continue execution. Use this to stop threads that are no longer needed."
  - name: complete
    link: /docs/reference/client-sdk/api-reference/threads/complete
...
the thread, but can be called manually when needed."
  - name: create
    link: /docs/reference/client-sdk/api-reference/threads/create
...
when ready. Use this to set up new execution units."
  - name: delete
    link: /docs/reference/client-sdk/api-reference/threads/delete
...
will also remove its relationships with other threads."
  - name: execute
    link: /docs/reference/client-sdk/api-reference/threads/execute
...
process its configured tasks and operations."
  - name: getById
    link: /docs/reference/client-sdk/api-reference/threads/getById
...
when you know the thread's ID."
  - name: getChildren
    link: /docs/reference/client-sdk/api-reference/threads/getChildren
...
This is useful for navigating thread hierarchies and managing related threads."
  - name: getDependencies
    link: /docs/reference/client-sdk/api-reference/threads/getDependencies
...
complex thread relationships."
  - name: getGraph
    link: /docs/reference/client-sdk/api-reference/threads/getGraph
...
hierarchies and dependencies."
  - name: getStatistics
    link: /docs/reference/client-sdk/api-reference/threads/getStatistics
...
and system performance."
  - name: getThreadInfo
    link: /docs/reference/client-sdk/api-reference/threads/getThreadInfo
...
thread, including its configuration, current state, and related attributes."
  - name: getTimeline
    link: /docs/reference/client-sdk/api-reference/threads/getTimeline
...
Use this to track thread activity and audit execution history."
  - name: getTree
    link: /docs/reference/client-sdk/api-reference/threads/getTree
...
visualizing thread hierarchies and understanding nested thread structures."
  - name: healthCheck
    link: /docs/reference/client-sdk/api-reference/threads/healthCheck
...
other thread operations."
  - name: list
    link: /docs/reference/client-sdk/api-reference/threads/list
...
threads or find specific sets of threads based on criteria."
  - name: pause
    link: /docs/reference/client-sdk/api-reference/threads/pause
...
temporarily halt execution without cancelling the thread."
  - name: resume
    link: /docs/reference/client-sdk/api-reference/threads/resume
...
active state and continue processing."
  - name: searchThread
    link: /docs/reference/client-sdk/api-reference/threads/searchThread
...
This is the most efficient way to retrieve a thread when you know its ID."
  - name: update
    link: /docs/reference/client-sdk/api-reference/threads/update
...
Use this to make changes to existing threads."
  - name: updateProgress
    link: /docs/reference/client-sdk/api-reference/threads/updateProgress
...
execution progress and providing feedback to users."
  - name: updateStatus
    link: /docs/reference/client-sdk/api-reference/threads/updateStatus
