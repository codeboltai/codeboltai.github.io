...
Defined in: CodeBolt/packages/clientsdk/src/sockets/shell.socket.ts:10

Shell WebSocket - Raw PTY bidirectional communication.
Send commands as text, receive output, support resize.

## Extends

- [`TypedEventEmitter`](TypedEventEmitter)\<`ShellSocketEvents`\>
...
Defined in: CodeBolt/packages/clientsdk/src/sockets/shell.socket.ts:14
...
| ------ | ------ |
| `event` | `K` |
| ...`args` | `Parameters`\<`ShellSocketEvents`\[`K`\]\> |
...
Defined in: CodeBolt/packages/clientsdk/src/sockets/shell.socket.ts:59
...
Defined in: CodeBolt/packages/clientsdk/src/sockets/shell.socket.ts:50
...
Defined in: CodeBolt/packages/clientsdk/src/sockets/shell.socket.ts:45
