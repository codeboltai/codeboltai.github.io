...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="context"></a> `context` | `protected` | `Record`\<`string`, `unknown`\> | `\{\}` | `BasePostInferenceProcessor.context` | packages/agent/src/processor-pieces/base/basePostInferenceProcessor.ts:16 |
