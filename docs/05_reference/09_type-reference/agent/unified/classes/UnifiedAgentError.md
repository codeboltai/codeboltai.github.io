...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="code"></a> `code` | `readonly` | `string` | - | - | packages/agent/src/unified/types/types.ts:280 |
| <a id="context"></a> `context?` | `readonly` | `Record`\<`string`, `any`\> | - | - | packages/agent/src/unified/types/types.ts:281 |
...
| <a id="stacktracelimit"></a> `stackTraceLimit` | `static` | `number` | The `Error.stackTraceLimit` property specifies the number of stack frames collected by a stack trace (whether generated by `new Error().stack` or `Error.captureStackTrace(obj)`). The default value is `10` but may be set to any valid JavaScript number. Changes will affect any stack trace captured _after_ the value has been changed. If set to a non-number value, or set to a negative number, stack traces will not capture any frames. | `Error.stackTraceLimit` | node\_modules/.pnpm/@types+node@20.19.19/node\_modules/@types/node/globals.d.ts:68 |
