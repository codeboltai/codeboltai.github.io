...
Defined in: packages/codeboltjs/src/tools/agent/agent-find.ts:117

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`AgentFindParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
new AgentFindTool(): AgentFindTool;
```

Defined in: packages/codeboltjs/src/tools/agent/agent-find.ts:120
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'agent_find'` | - | - | packages/codeboltjs/src/tools/agent/agent-find.ts:118 |
...
```ts
build(params: AgentFindParams): ToolInvocation<AgentFindParams, ToolFrameworkResult>;
```
...
| Parameter | Type |
| ------ | ------ |
| `params` | `AgentFindParams` |

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation)\<`AgentFindParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: AgentFindParams): ToolInvocation<AgentFindParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/agent/agent-find.ts:154
...
```ts
validateBuildAndExecute(params: AgentFindParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
```ts
validateToolParams(params: AgentFindParams): string | null;
```
...
Defined in: packages/codeboltjs/src/tools/agent/agent-find.ts:147
