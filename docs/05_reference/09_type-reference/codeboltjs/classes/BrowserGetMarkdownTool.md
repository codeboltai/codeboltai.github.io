...
# Class: BrowserGetMarkdownTool

Defined in: packages/codeboltjs/src/tools/browser/get-markdown.ts:65

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`BrowserGetMarkdownParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
new BrowserGetMarkdownTool(): BrowserGetMarkdownTool;
```

Defined in: packages/codeboltjs/src/tools/browser/get-markdown.ts:68
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'browser_get_markdown'` | - | - | packages/codeboltjs/src/tools/browser/get-markdown.ts:66 |
...
```ts
build(params: BrowserGetMarkdownParams): ToolInvocation<BrowserGetMarkdownParams, ToolFrameworkResult>;
```
...
| Parameter | Type |
| ------ | ------ |
| `params` | `BrowserGetMarkdownParams` |

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation)\<`BrowserGetMarkdownParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: BrowserGetMarkdownParams): ToolInvocation<BrowserGetMarkdownParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/browser/get-markdown.ts:91
...
```ts
validateBuildAndExecute(params: BrowserGetMarkdownParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
```ts
validateToolParams(params: BrowserGetMarkdownParams): string | null;
```
...
```ts
protected validateToolParamValues(_params: BrowserGetMarkdownParams): string | null;
```
...
| Parameter | Type |
| ------ | ------ |
| `_params` | `BrowserGetMarkdownParams` |
