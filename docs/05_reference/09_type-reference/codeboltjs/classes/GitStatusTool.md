...
- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`GitStatusParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'git_status'` | - | - | packages/codeboltjs/src/tools/git/status.ts:108 |
...
[`ToolInvocation`](../interfaces/ToolInvocation)\<`GitStatusParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
