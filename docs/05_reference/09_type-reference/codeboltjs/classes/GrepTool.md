...
Defined in: packages/codeboltjs/src/tools/search/grep.ts:143

Implementation of the Grep tool logic

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`GrepToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
Defined in: packages/codeboltjs/src/tools/search/grep.ts:149
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'grep'` | - | - | packages/codeboltjs/src/tools/search/grep.ts:147 |
...
```ts
build(params: GrepToolParams): ToolInvocation<GrepToolParams, ToolFrameworkResult>;
```
...
[`ToolInvocation`](../interfaces/ToolInvocation)\<`GrepToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: GrepToolParams): ToolInvocation<GrepToolParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/search/grep.ts:212
...
```ts
validateBuildAndExecute(params: GrepToolParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
Defined in: packages/codeboltjs/src/tools/search/grep.ts:194
