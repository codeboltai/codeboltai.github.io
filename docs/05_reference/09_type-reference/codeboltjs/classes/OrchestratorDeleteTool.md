...
# Class: OrchestratorDeleteTool

Defined in: packages/codeboltjs/src/tools/orchestrator/orchestrator-delete.ts:55

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`OrchestratorDeleteParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
new OrchestratorDeleteTool(): OrchestratorDeleteTool;
```

Defined in: packages/codeboltjs/src/tools/orchestrator/orchestrator-delete.ts:58
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'orchestrator_delete'` | - | - | packages/codeboltjs/src/tools/orchestrator/orchestrator-delete.ts:56 |
...
```ts
build(params: OrchestratorDeleteParams): ToolInvocation<OrchestratorDeleteParams, ToolFrameworkResult>;
```
...
| Parameter | Type |
| ------ | ------ |
| `params` | `OrchestratorDeleteParams` |

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation)\<`OrchestratorDeleteParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: OrchestratorDeleteParams): ToolInvocation<OrchestratorDeleteParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/orchestrator/orchestrator-delete.ts:84
...
```ts
validateBuildAndExecute(params: OrchestratorDeleteParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
```ts
validateToolParams(params: OrchestratorDeleteParams): string | null;
```
...
```ts
protected validateToolParamValues(params: OrchestratorDeleteParams): string | null;
```

Defined in: packages/codeboltjs/src/tools/orchestrator/orchestrator-delete.ts:77
