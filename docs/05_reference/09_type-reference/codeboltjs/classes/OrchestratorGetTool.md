...
# Class: OrchestratorGetTool

Defined in: packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts:69

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`OrchestratorGetParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
new OrchestratorGetTool(): OrchestratorGetTool;
```

Defined in: packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts:72
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'orchestrator_get'` | - | - | packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts:70 |
...
```ts
build(params: OrchestratorGetParams): ToolInvocation<OrchestratorGetParams, ToolFrameworkResult>;
```
...
| Parameter | Type |
| ------ | ------ |
| `params` | `OrchestratorGetParams` |

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation)\<`OrchestratorGetParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: OrchestratorGetParams): ToolInvocation<OrchestratorGetParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts:98
...
```ts
validateBuildAndExecute(params: OrchestratorGetParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
```ts
validateToolParams(params: OrchestratorGetParams): string | null;
```
...
```ts
protected validateToolParamValues(params: OrchestratorGetParams): string | null;
```

Defined in: packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts:91
