...
- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`OrchestratorUpdateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'orchestrator_update'` | - | - | packages/codeboltjs/src/tools/orchestrator/orchestrator-update.ts:79 |
...
[`ToolInvocation`](../interfaces/ToolInvocation)\<`OrchestratorUpdateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
