...
Defined in: packages/codeboltjs/src/tools/file/read-file.ts:152

Implementation of the ReadFile tool logic

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`ReadFileToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
Defined in: packages/codeboltjs/src/tools/file/read-file.ts:158
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'read_file'` | - | - | packages/codeboltjs/src/tools/file/read-file.ts:156 |
...
```ts
build(params: ReadFileToolParams): ToolInvocation<ReadFileToolParams, ToolFrameworkResult>;
```
...
[`ToolInvocation`](../interfaces/ToolInvocation)\<`ReadFileToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: ReadFileToolParams): ToolInvocation<ReadFileToolParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/file/read-file.ts:216
...
```ts
validateBuildAndExecute(params: ReadFileToolParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
Defined in: packages/codeboltjs/src/tools/file/read-file.ts:193
