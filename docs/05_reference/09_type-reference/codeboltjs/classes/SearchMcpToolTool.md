...
# Class: SearchMcpToolTool

Defined in: packages/codeboltjs/src/tools/search/search-mcp-tool.ts:116

Implementation of the SearchMcpTool tool logic

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`SearchMcpToolToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
new SearchMcpToolTool(): SearchMcpToolTool;
```

Defined in: packages/codeboltjs/src/tools/search/search-mcp-tool.ts:122
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'search_mcp_tool'` | - | - | packages/codeboltjs/src/tools/search/search-mcp-tool.ts:120 |
...
```ts
build(params: SearchMcpToolToolParams): ToolInvocation<SearchMcpToolToolParams, ToolFrameworkResult>;
```
...
[`ToolInvocation`](../interfaces/ToolInvocation)\<`SearchMcpToolToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: SearchMcpToolToolParams): ToolInvocation<SearchMcpToolToolParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/search/search-mcp-tool.ts:163
...
```ts
validateBuildAndExecute(params: SearchMcpToolToolParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
```ts
validateToolParams(params: SearchMcpToolToolParams): string | null;
```
...
```ts
protected validateToolParamValues(params: SearchMcpToolToolParams): string | null;
```

Defined in: packages/codeboltjs/src/tools/search/search-mcp-tool.ts:153
