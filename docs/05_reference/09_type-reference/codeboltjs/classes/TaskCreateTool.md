...
Defined in: packages/codeboltjs/src/tools/task/task-create.ts:79

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`TaskCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
new TaskCreateTool(): TaskCreateTool;
```

Defined in: packages/codeboltjs/src/tools/task/task-create.ts:82
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'task_create'` | - | - | packages/codeboltjs/src/tools/task/task-create.ts:80 |
...
```ts
build(params: TaskCreateParams): ToolInvocation<TaskCreateParams, ToolFrameworkResult>;
```
...
[`ToolInvocation`](../interfaces/ToolInvocation)\<`TaskCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: TaskCreateParams): ToolInvocation<TaskCreateParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/task/task-create.ts:120
...
```ts
validateBuildAndExecute(params: TaskCreateParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
```ts
validateToolParams(params: TaskCreateParams): string | null;
```
...
Defined in: packages/codeboltjs/src/tools/task/task-create.ts:113
