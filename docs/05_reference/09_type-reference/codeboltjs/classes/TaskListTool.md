...
Defined in: packages/codeboltjs/src/tools/task/task-list.ts:71
...
Defined in: packages/codeboltjs/src/tools/task/task-list.ts:74
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'task_list'` | - | - | packages/codeboltjs/src/tools/task/task-list.ts:72 |
...
Defined in: packages/codeboltjs/src/tools/task/task-list.ts:93
...
```ts
validateToolParams(params: TaskListParams): string | null;
```
...
```ts
protected validateToolParamValues(_params: TaskListParams): string | null;
```
