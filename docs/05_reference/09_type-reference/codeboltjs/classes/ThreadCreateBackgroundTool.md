---
title: ThreadCreateBackgroundTool
---
...
# Class: ThreadCreateBackgroundTool

Defined in: packages/codeboltjs/src/tools/thread/thread-create-background.ts:81

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool)\<`ThreadCreateBackgroundParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
new ThreadCreateBackgroundTool(): ThreadCreateBackgroundTool;
```

Defined in: packages/codeboltjs/src/tools/thread/thread-create-background.ts:84
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'thread_create_background'` | - | - | packages/codeboltjs/src/tools/thread/thread-create-background.ts:82 |
...
```ts
build(params: ThreadCreateBackgroundParams): ToolInvocation<ThreadCreateBackgroundParams, ToolFrameworkResult>;
```
...
| Parameter | Type |
| ------ | ------ |
| `params` | `ThreadCreateBackgroundParams` |

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation)\<`ThreadCreateBackgroundParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult)\>
...
```ts
protected createInvocation(params: ThreadCreateBackgroundParams): ToolInvocation<ThreadCreateBackgroundParams, ToolFrameworkResult>;
```

Defined in: packages/codeboltjs/src/tools/thread/thread-create-background.ts:131
...
```ts
validateBuildAndExecute(params: ThreadCreateBackgroundParams, abortSignal: AbortSignal): Promise<ToolFrameworkResult>;
```
...
```ts
validateToolParams(params: ThreadCreateBackgroundParams): string | null;
```
...
Defined in: packages/codeboltjs/src/tools/thread/thread-create-background.ts:127

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `_params` | `ThreadCreateBackgroundParams` |
