...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/codemap.d.ts:62
...
| <a id="data"></a> `data?` | \{ `codemap`: [`Codemap`](Codemap) \| [`CodemapInfo`](CodemapInfo); \} | - | common/types/dist/codeboltjstypes/libFunctionTypes/codemap.d.ts:63 |
| `data.codemap` | [`Codemap`](Codemap) \| [`CodemapInfo`](CodemapInfo) | - | common/types/dist/codeboltjstypes/libFunctionTypes/codemap.d.ts:64 |
