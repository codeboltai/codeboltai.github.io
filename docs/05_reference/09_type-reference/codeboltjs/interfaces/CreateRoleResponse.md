...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:258
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `role`: [`Role`](Role); \} | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:259 |
| `data.role` | [`Role`](Role) | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:260 |
