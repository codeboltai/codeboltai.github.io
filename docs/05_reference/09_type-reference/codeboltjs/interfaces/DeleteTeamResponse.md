...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:250
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:251 |
| `data.message` | `string` | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:252 |
