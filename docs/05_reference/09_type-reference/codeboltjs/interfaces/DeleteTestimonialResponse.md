...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:140
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `deleted`: `boolean`; \} | Deletion result - returned in 'data' property from cliLib | - | common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:142 |
| `data.deleted` | `boolean` | - | - | common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:143 |
