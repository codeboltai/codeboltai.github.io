...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/eventLog.d.ts:102
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `event`: [`EventLogEntry`](EventLogEntry); \} | [`EventLogBaseResponse`](EventLogBaseResponse).[`data`](EventLogBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/eventLog.d.ts:103 |
| `data.event` | [`EventLogEntry`](EventLogEntry) | - | - | common/types/dist/codeboltjstypes/libFunctionTypes/eventLog.d.ts:104 |
