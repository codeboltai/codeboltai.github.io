...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:124
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`AgentPortfolio`](AgentPortfolio) | Agent portfolio data - returned in 'data' property from cliLib | - | common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:126 |
