...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:178
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`AgentPortfolio`](AgentPortfolio)[] | Project portfolios - returned in 'data' property from cliLib | - | common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:180 |
