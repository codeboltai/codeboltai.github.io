...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:170
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`Talent`](Talent)[] | Talents list - returned in 'data' property from cliLib | - | common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:172 |
