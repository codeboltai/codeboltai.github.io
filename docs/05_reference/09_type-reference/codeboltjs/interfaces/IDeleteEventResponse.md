...
Defined in: packages/codeboltjs/src/modules/calendar.ts:192
...
| <a id="data"></a> `data?` | `any` | [`CalendarResponse`](CalendarResponse).[`data`](CalendarResponse.md#data) | packages/codeboltjs/src/modules/calendar.ts:172 |
