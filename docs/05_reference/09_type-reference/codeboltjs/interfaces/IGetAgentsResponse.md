...
Defined in: packages/codeboltjs/src/modules/episodicMemory.ts:158
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | `string`[] | [`EpisodicMemoryResponse`](EpisodicMemoryResponse).[`data`](EpisodicMemoryResponse.md#data) | - | packages/codeboltjs/src/modules/episodicMemory.ts:159 |
