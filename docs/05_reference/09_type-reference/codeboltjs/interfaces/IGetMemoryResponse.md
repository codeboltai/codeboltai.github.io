...
# Interface: IGetMemoryResponse

Defined in: packages/codeboltjs/src/modules/episodicMemory.ts:134
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`EpisodicMemory`](EpisodicMemory) | [`EpisodicMemoryResponse`](EpisodicMemoryResponse).[`data`](EpisodicMemoryResponse.md#data) | - | packages/codeboltjs/src/modules/episodicMemory.ts:135 |
