...
Defined in: packages/codeboltjs/src/modules/calendar.ts:241
...
| <a id="data"></a> `data?` | \{ `count`: `number`; `events`: [`CalendarEvent`](CalendarEvent)[]; \} | [`CalendarResponse`](CalendarResponse).[`data`](CalendarResponse.md#data) | - | packages/codeboltjs/src/modules/calendar.ts:242 |
| `data.count` | `number` | - | - | packages/codeboltjs/src/modules/calendar.ts:244 |
| `data.events` | [`CalendarEvent`](CalendarEvent)[] | - | - | packages/codeboltjs/src/modules/calendar.ts:243 |
