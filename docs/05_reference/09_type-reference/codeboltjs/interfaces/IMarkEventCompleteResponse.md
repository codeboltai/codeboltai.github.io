...
Defined in: packages/codeboltjs/src/modules/calendar.ts:228
...
| <a id="data"></a> `data?` | \{ `event`: [`CalendarEvent`](CalendarEvent); \} | [`CalendarResponse`](CalendarResponse).[`data`](CalendarResponse.md#data) | - | packages/codeboltjs/src/modules/calendar.ts:229 |
| `data.event` | [`CalendarEvent`](CalendarEvent) | - | - | packages/codeboltjs/src/modules/calendar.ts:230 |
