...
# Interface: IUnarchiveMemoryResponse

Defined in: packages/codeboltjs/src/modules/episodicMemory.ts:168
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | [`EpisodicMemoryResponse`](EpisodicMemoryResponse).[`data`](EpisodicMemoryResponse.md#data) | - | packages/codeboltjs/src/modules/episodicMemory.ts:169 |
| `data.message` | `string` | - | - | packages/codeboltjs/src/modules/episodicMemory.ts:170 |
