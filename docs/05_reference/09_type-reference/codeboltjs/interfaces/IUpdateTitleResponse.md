...
# Interface: IUpdateTitleResponse

Defined in: packages/codeboltjs/src/modules/episodicMemory.ts:174
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | [`EpisodicMemoryResponse`](EpisodicMemoryResponse).[`data`](EpisodicMemoryResponse.md#data) | - | packages/codeboltjs/src/modules/episodicMemory.ts:175 |
| `data.message` | `string` | - | - | packages/codeboltjs/src/modules/episodicMemory.ts:176 |
