...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:152
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGInstance`](KGInstance)[] | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:153 |
