...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:146
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGInstanceTemplate`](KGInstanceTemplate)[] | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:147 |
