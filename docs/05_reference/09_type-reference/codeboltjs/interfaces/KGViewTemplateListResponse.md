...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:170
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGViewTemplate`](KGViewTemplate)[] | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/knowledgeGraph.d.ts:171 |
