...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:110
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `deletedCount`: `number`; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:111 |
| `data.deletedCount` | `number` | - | - | common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:112 |
