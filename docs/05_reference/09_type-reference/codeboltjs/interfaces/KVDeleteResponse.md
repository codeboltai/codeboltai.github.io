...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:105
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `deleted`: `boolean`; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:106 |
| `data.deleted` | `boolean` | - | - | common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:107 |
