...
# Interface: KVRecordCountResponse

Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:125
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `count`: `number`; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:126 |
| `data.count` | `number` | - | - | common/types/dist/codeboltjstypes/libFunctionTypes/kvStore.d.ts:127 |
