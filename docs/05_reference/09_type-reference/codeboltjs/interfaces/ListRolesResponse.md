...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:266
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `roles`: [`Role`](Role)[]; \} | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:267 |
| `data.roles` | [`Role`](Role)[] | - | common/types/dist/codeboltjstypes/libFunctionTypes/swarm.d.ts:268 |
