...
| ------ | ------ | ------ | ------ |
| <a id="function"></a> `function` | \{ `description?`: `string`; `name`: `string`; `parameters?`: `JSONSchema`; \} | Function definition | packages/codeboltjs/src/types/libFunctionTypes.ts:120 |
...
| <a id="type"></a> `type` | `"function"` | The type of tool | packages/codeboltjs/src/types/libFunctionTypes.ts:118 |
