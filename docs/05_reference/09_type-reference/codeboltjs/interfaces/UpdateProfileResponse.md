...
Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:182
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`AgentPortfolio`](AgentPortfolio) | Updated portfolio data - returned in 'data' property from cliLib | - | common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:184 |
