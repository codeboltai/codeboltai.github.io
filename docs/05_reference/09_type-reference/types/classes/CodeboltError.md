...
| ------ | ------ | ------ | ------ | ------ |
| <a id="code"></a> `code?` | `public` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/common.ts:279 |
| <a id="details"></a> `details?` | `public` | `any` | - | common/types/src/codeboltjstypes/libFunctionTypes/common.ts:280 |
...
| <a id="timestamp"></a> `timestamp` | `public` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/common.ts:275 |
