...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:56
...
| <a id="id"></a> `id?` | `string` | Todo item ID | - | common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:60 |
...
| <a id="todo"></a> `todo?` | [`TodoItem`](TodoItem) | Created todo item | - | common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:58 |
