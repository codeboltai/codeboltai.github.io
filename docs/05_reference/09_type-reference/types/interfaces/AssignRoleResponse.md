...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:292 |
| `data.message` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:292 |
