...
# Interface: BaseMemorySDKResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:74

## Extended by

- [`MemorySetResponse`](MemorySetResponse)
- [`MemoryGetResponse`](MemoryGetResponse)
- [`MemoryDeleteResponse`](MemoryDeleteResponse)
- [`MemoryListResponse`](MemoryListResponse)
- [`MemoryClearResponse`](MemoryClearResponse)
- [`MemorySearchResponse`](MemorySearchResponse)
- [`MemoryExistsResponse`](MemoryExistsResponse)
- [`MemoryExpireResponse`](MemoryExpireResponse)
- [`MemoryTTLResponse`](MemoryTTLResponse)
