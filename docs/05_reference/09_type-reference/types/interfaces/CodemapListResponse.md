...
| <a id="data"></a> `data?` | \{ `codemaps`: [`CodemapInfo`](CodemapInfo)[]; `count`: `number`; \} | - | common/types/src/codeboltjstypes/libFunctionTypes/codemap.ts:76 |
| `data.codemaps` | [`CodemapInfo`](CodemapInfo)[] | - | common/types/src/codeboltjstypes/libFunctionTypes/codemap.ts:77 |
| `data.count` | `number` | - | common/types/src/codeboltjstypes/libFunctionTypes/codemap.ts:78 |
