...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:186
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `swarm`: [`Swarm`](Swarm); \} | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:187 |
| `data.swarm` | [`Swarm`](Swarm) | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:187 |
