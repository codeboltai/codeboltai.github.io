...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:50
...
| ------ | ------ | ------ | ------ |
| <a id="deleted"></a> `deleted?` | `boolean` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:52 |
...
| <a id="movetotrash"></a> `moveToTrash?` | `boolean` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:53 |
| <a id="path"></a> `path?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:51 |
| <a id="recoveredfrombackup"></a> `recoveredFromBackup?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:55 |
...
| <a id="trashlocation"></a> `trashLocation?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/fs.ts:54 |
