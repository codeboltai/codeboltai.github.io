...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts:118
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `count`: `number`; `events`: [`EventLogEntry`](EventLogEntry)[]; \} | [`EventLogBaseResponse`](EventLogBaseResponse).[`data`](EventLogBaseResponse.md#data) | - | common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts:119 |
| `data.count` | `number` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts:119 |
| `data.events` | [`EventLogEntry`](EventLogEntry)[] | - | - | common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts:119 |
