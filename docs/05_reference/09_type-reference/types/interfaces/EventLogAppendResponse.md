...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `event`: [`EventLogEntry`](EventLogEntry); \} | [`EventLogBaseResponse`](EventLogBaseResponse).[`data`](EventLogBaseResponse.md#data) | - | common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts:115 |
| `data.event` | [`EventLogEntry`](EventLogEntry) | - | - | common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts:115 |
