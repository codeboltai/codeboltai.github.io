...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts:122
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `result`: [`EventLogQueryResult`](EventLogQueryResult); \} | [`EventLogBaseResponse`](EventLogBaseResponse).[`data`](EventLogBaseResponse.md#data) | - | common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts:123 |
| `data.result` | [`EventLogQueryResult`](EventLogQueryResult) | - | - | common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts:123 |
