---
title: GetAllIncompleteTodosResponse
---
...
# Interface: GetAllIncompleteTodosResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:75
...
| <a id="todos"></a> `todos?` | [`TodoItem`](TodoItem)[] | Incomplete todo items | - | common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:77 |
