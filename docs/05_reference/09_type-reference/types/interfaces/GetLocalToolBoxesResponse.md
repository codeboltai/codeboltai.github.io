---
title: GetLocalToolBoxesResponse
---
...
# Interface: GetLocalToolBoxesResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/mcp.ts:76
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `enabled`: `boolean`; `name`: `string`; `tools?`: \{ `description?`: `string`; `name`: `string`; `parameters?`: `Record`\<`string`, `unknown`\>; \}[]; \}[] | - | common/types/src/codeboltjstypes/libFunctionTypes/mcp.ts:77 |
