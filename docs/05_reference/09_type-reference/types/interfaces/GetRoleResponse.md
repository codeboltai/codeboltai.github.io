...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:284
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `assignees`: [`SwarmAgent`](SwarmAgent)[]; `role`: [`Role`](Role); \} | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:285 |
| `data.assignees` | [`SwarmAgent`](SwarmAgent)[] | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:285 |
| `data.role` | [`Role`](Role) | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:285 |
