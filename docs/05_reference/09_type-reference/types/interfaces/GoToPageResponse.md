...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/browser.ts:50
...
| <a id="url"></a> `url?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/browser.ts:51 |
