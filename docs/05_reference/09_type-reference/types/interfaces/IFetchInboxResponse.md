...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:63
...
| <a id="error"></a> `error?` | `string` | [`BaseApplicationResponse`](BaseApplicationResponse).[`error`](BaseApplicationResponse.md#error) | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:66 |
...
| <a id="messages"></a> `messages?` | `any`[] | - | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:65 |
...
| <a id="success"></a> `success?` | `boolean` | [`BaseApplicationResponse`](BaseApplicationResponse).[`success`](BaseApplicationResponse.md#success) | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:64 |
