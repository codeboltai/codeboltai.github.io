---
title: IForceReserveFilesResponse
---
...
# Interface: IForceReserveFilesResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:179
...
| <a id="error"></a> `error?` | `string` | [`BaseApplicationResponse`](BaseApplicationResponse).[`error`](BaseApplicationResponse.md#error) | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:183 |
...
| <a id="reservationid"></a> `reservationId?` | `string` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:182 |
| <a id="reserved"></a> `reserved?` | `boolean` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:181 |
| <a id="success"></a> `success?` | `boolean` | [`BaseApplicationResponse`](BaseApplicationResponse).[`success`](BaseApplicationResponse.md#success) | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:180 |
