...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:107
...
| <a id="error"></a> `error?` | `string` | [`BaseApplicationResponse`](BaseApplicationResponse).[`error`](BaseApplicationResponse.md#error) | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:109 |
...
| <a id="success"></a> `success?` | `boolean` | [`BaseApplicationResponse`](BaseApplicationResponse).[`success`](BaseApplicationResponse.md#success) | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:108 |
