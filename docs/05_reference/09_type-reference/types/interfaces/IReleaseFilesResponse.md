...
# Interface: IReleaseFilesResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:167
...
| <a id="error"></a> `error?` | `string` | [`BaseApplicationResponse`](BaseApplicationResponse).[`error`](BaseApplicationResponse.md#error) | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:170 |
...
| <a id="released"></a> `released?` | `boolean` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:169 |
...
| <a id="success"></a> `success?` | `boolean` | [`BaseApplicationResponse`](BaseApplicationResponse).[`success`](BaseApplicationResponse.md#success) | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:168 |
