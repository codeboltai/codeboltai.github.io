...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:96
...
| <a id="error"></a> `error?` | `string` | [`BaseApplicationResponse`](BaseApplicationResponse).[`error`](BaseApplicationResponse.md#error) | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:99 |
...
| <a id="messageid"></a> `messageId?` | `string` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:98 |
...
| <a id="success"></a> `success?` | `boolean` | [`BaseApplicationResponse`](BaseApplicationResponse).[`success`](BaseApplicationResponse.md#success) | - | common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:97 |
