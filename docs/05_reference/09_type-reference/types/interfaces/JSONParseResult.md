...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/outputparsers.ts:13
...
| <a id="parsed"></a> `parsed?` | `unknown` | - | common/types/src/codeboltjstypes/libFunctionTypes/outputparsers.ts:14 |
