...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:117
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `deleted`: `boolean`; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:118 |
| `data.deleted` | `boolean` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:118 |
