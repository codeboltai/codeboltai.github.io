...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `instances`: [`KVStoreInstance`](KVStoreInstance)[]; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:106 |
| `data.instances` | [`KVStoreInstance`](KVStoreInstance)[] | - | - | common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:106 |
