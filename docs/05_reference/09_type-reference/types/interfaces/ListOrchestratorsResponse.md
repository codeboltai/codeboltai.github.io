---
title: ListOrchestratorsResponse
---
...
# Interface: ListOrchestratorsResponse

Defined in: common/types/src/codeboltjstypes/libFunctionTypes/orchestrator.ts:96
...
- [`BaseOrchestratorSDKResponse`](BaseOrchestratorSDKResponse)

## Properties

| Property | Type | Inherited from | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`OrchestratorInstance`](OrchestratorInstance)[] | - | common/types/src/codeboltjstypes/libFunctionTypes/orchestrator.ts:98 |
...
| <a id="requestid"></a> `requestId?` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/orchestrator.ts:97 |
