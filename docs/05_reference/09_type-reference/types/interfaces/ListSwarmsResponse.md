...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:193
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `swarms`: [`Swarm`](Swarm)[]; \} | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:194 |
| `data.swarms` | [`Swarm`](Swarm)[] | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:194 |
