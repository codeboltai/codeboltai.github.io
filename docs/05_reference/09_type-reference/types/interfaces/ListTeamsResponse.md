...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:235
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `teams`: [`Team`](Team)[]; \} | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:236 |
| `data.teams` | [`Team`](Team)[] | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:236 |
