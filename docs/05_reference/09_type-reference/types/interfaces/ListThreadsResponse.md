...
| <a id="hasmore"></a> `hasMore?` | `boolean` | - | common/types/src/codeboltjstypes/libFunctionTypes/thread.ts:178 |
| <a id="limit"></a> `limit?` | `number` | - | common/types/src/codeboltjstypes/libFunctionTypes/thread.ts:176 |
...
| <a id="offset"></a> `offset?` | `number` | - | common/types/src/codeboltjstypes/libFunctionTypes/thread.ts:177 |
...
| <a id="threads"></a> `threads?` | [`ThreadData`](ThreadData)[] | - | common/types/src/codeboltjstypes/libFunctionTypes/thread.ts:174 |
| <a id="total"></a> `total?` | `number` | - | common/types/src/codeboltjstypes/libFunctionTypes/thread.ts:175 |
