...
| ------ | ------ | ------ | ------ | ------ |
| <a id="entries"></a> `entries?` | `Record`\<`string`, [`MemoryEntry`](MemoryEntry)\> | - | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:113 |
...
| <a id="keys"></a> `keys?` | `string`[] | - | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:112 |
...
| <a id="metadata"></a> `metadata?` | `Record`\<`string`, `unknown`\> | List operation metadata | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:117 |
...
| <a id="result"></a> `result?` | [`MemoryListResult`](MemoryListResult) | List result data | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:115 |
