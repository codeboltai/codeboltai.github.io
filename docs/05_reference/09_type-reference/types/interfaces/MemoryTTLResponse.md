...
| <a id="key"></a> `key?` | `string` | - | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:155 |
...
| <a id="metadata"></a> `metadata?` | `Record`\<`string`, `unknown`\> | TTL check metadata | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:159 |
...
| <a id="ttl"></a> `ttl?` | `number` | Time to live in seconds | - | common/types/src/codeboltjstypes/libFunctionTypes/memory.ts:157 |
