...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:221
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:222 |
| `data.message` | `string` | - | common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:222 |
