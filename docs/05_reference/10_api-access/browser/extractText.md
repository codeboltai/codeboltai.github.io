...
The method returns a Promise that resolves to an [`ExtractTextResponse`](/docs/reference/type-reference/types/interfaces/ExtractTextResponse) object with the following properties:
