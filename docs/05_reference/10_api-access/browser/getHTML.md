...
The method returns a Promise that resolves to a [`HtmlReceived`](/docs/reference/type-reference/types/interfaces/HtmlReceived) object with the following properties:
