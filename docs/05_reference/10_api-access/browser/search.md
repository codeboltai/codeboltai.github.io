...
The method returns a Promise that resolves to a [`BrowserActionResponseData`](/docs/reference/type-reference/types/interfaces/BrowserActionResponseData) object with the following properties:
