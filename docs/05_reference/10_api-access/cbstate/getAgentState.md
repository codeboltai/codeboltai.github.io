...
The method returns a Promise that resolves to a [`GetAgentStateResponse`](/docs/reference/type-reference/types/interfaces/GetAgentStateResponse) object with the following properties:
