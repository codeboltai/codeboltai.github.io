...
The method returns a Promise that resolves to a [`GetAppStateResponse`](/docs/reference/type-reference/types/interfaces/GetAppStateResponse) object with the following properties:
