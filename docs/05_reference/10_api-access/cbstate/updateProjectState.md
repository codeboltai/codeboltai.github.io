...
The method returns a Promise that resolves to an [`UpdateProjectStateResponse`](/docs/reference/type-reference/types/interfaces/UpdateProjectStateResponse) object with the following properties:
