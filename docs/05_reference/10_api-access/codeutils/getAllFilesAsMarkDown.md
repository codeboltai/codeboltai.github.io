...
- **`Promise<GetAllFilesMarkdownResponse>`**: A promise that resolves with a [`GetAllFilesMarkdownResponse`](/docs/reference/type-reference/types/interfaces/GetAllFilesMarkdownResponse) object containing the Markdown content of all files in the project.

### Response Structure

The method returns a Promise that resolves to a [`GetAllFilesMarkdownResponse`](/docs/reference/type-reference/types/interfaces/GetAllFilesMarkdownResponse) object with the following properties:
