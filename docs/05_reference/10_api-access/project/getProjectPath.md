...
The method returns a Promise that resolves to a [`GetProjectPathResponse`](/docs/reference/type-reference/types/interfaces/GetProjectPathResponse) object with the following properties:
