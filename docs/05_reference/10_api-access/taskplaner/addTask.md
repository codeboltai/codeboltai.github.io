...
The method returns a Promise that resolves to an [`AddTaskResponse`](/docs/reference/type-reference/types/interfaces/AddTaskResponse) object with the following properties:
