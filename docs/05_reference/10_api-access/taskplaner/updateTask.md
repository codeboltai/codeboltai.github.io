...
The method returns a Promise that resolves to an [`UpdateTasksResponse`](/docs/reference/type-reference/types/interfaces/UpdateTasksResponse) object with the following properties:
