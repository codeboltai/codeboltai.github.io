...
The method returns a Promise that resolves to an [`AddTodoResponse`](/docs/reference/type-reference/types/interfaces/AddTodoResponse) object with the following properties:
