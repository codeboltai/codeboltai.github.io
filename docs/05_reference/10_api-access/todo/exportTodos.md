...
The method returns a Promise that resolves to an [`ExportTodosResponse`](/docs/reference/type-reference/types/interfaces/ExportTodosResponse) object with the following properties:
