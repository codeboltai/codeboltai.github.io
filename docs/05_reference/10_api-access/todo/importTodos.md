...
The method returns a Promise that resolves to an [`ImportTodosResponse`](/docs/reference/type-reference/types/interfaces/ImportTodosResponse) object with the following properties:
