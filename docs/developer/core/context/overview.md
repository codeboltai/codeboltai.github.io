...
- [Agents](../agents/overview.md) - Agents use context for intelligent decision-making
- [Chats](../chats/overview.md) - Context powers relevant, project-aware conversations
- [Inline Edit](../inline-edit/overview.md) - Context ensures code transformations fit your patterns
- [Task Flow](../task-flow/overview.md) - Workflows adapt based on project context
