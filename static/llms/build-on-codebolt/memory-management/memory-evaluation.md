...
> Evaluating memory means measuring whether agents are retrieving the right information at the right time and whether the pipeline that writes to storage is.
